...
export function FunctionSignatureType(props: Readonly<FunctionSignatureProps>) {
  ...
  return (
    <ts.TypeDeclaration export name={props.signature.typeName} doc={getDocComment(func)}>
