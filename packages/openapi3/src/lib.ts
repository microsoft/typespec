...
export const libDef = {
  ...
  diagnostics: {
    ...
    "xml-attribute-invalid-property-type": {
      severity: "warning",
      messages: {
        default: paramMessage`The XML Attribute can only be primitive types in the OpenAPI 3 emitter, Propertie '${"name"}' will be ignored.`,
      },
    },
    "xml-unwrapped-invalid-property-type": {
      severity: "warning",
      messages: {
        default: paramMessage`The XML Unwrapped can only used on array properties or primitive ones in the OpenAPI 3 emitter, Propertie '${"name"}' will be ignored.`,
      },
    },
  },
  emitter: {
