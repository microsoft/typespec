...
describe("service-generator-csharp: diagnostics", () => {
  ...
  it("warns for custom scalars", async () => {
    ...
    expectDiagnostics(diagnostics, [
      {
        code: "@typespec/service-generator-csharp/unrecognized-scalar",
        message:
  ...
  it("warns for invalid identifiers", async () => {
    ...
    expectDiagnostics(diagnostics, [
      {
        code: "@typespec/service-generator-csharp/invalid-identifier",
        message:
  ...
  it("Warns for unnamed model instantiations", async () => {});
});
