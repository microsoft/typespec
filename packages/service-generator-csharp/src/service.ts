...
export async function $onEmit(context: EmitContext<CSharpServiceEmitterOptions>) {
  ...
  class CSharpCodeEmitter extends CodeTypeEmitter {
    ...
    enumDeclaration(en: Enum, name: string): EmitterOutput<string> {
      ...
      return this.emitter.result.declaration(
        ...
        namespace ${namespace}
        {
            ...
            ${attributes.map((attribute) => attribute.getApplicationString()).join("\n")}
    ...
    #emitUsings(context: Context & { usedNamespaces: Set<string> }): EmitterOutput<string> {
      const builder: StringBuilder = new StringBuilder();
      for (const ns of [...context.usedNamespaces.values()])
    ...
    modelDeclaration(model: Model, name: string): EmitterOutput<string> {
      ...
      const decl = this.emitter.result.declaration(
        ...
        code`${this.#licenseHeader}
      // <auto-generated />
      ${this.#emitUsings(this.emitter.getContext() as Context & { usedNamespaces: Set<string> })}
