...
foreach ($directory in $directories) {
    ...
    $outputDir = $directory.FullName.Substring(0, $directory.FullName.IndexOf("src") - 1).Replace("\", "/") # replace \ with / for the path for usuing unix style separators to avoid warnings
