...
describe("Test Spread Parameters", () => {
  ...
  beforeEach(async () => {
    ...
    it("Spread parameters are present in service method", async () => {
      ...
      strictEqual(fooParam.kind, InputParameterKind.Spread)
    ...
    it("Parameters that are constants are converted to enums", async () => {
      ...
      strictEqual(kindParam.kind, InputParameterKind.Spread)
      ...
      strictEqual(nameParam.kind, InputParameterKind.Spread)
