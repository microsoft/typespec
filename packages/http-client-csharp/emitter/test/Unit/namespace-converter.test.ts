...
describe("Namespace Converter", () => {
  ...
  describe("fromSdkNamespaces", () => {
    it("Are cached and parsed correctly", async () => {
        const options: TypeSpecCompileOptions = {}
        ...
        strictEqual(testChildNamespace.fullName, "Azure.Csharp.Testing.TestNestedNs.TestChildNamespace")
