...
For detailed instructions on how to use and create plugins for the C# emitter, see the [Plugins Guide](https://github.com/microsoft/typespec/blob/main/packages/http-client-csharp/.tspd/docs/plugins.md).
