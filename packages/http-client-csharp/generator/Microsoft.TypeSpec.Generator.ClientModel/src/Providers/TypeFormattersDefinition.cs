        ...
        private ValueExpression BuildSwitchExpression(ValueExpression value, ValueExpression formatParameter, VariableExpression formatSpecifier, CSharpType serializationFormatType, ValueExpression invariantCulture)
        {
            return new SwitchExpression(
                ...
                SwitchCaseExpression.When(new DeclarationExpression(typeof(TimeSpan), "timeSpan", out var timeSpanSecondsLong),
                    ...
                    ConvertSnippets.InvokeToInt64(timeSpanSecondsLong.As<TimeSpan>().TotalSeconds()).InvokeToString(invariantCulture)),
                ...
                SwitchCaseExpression.When(new DeclarationExpression(typeof(TimeSpan), "timeSpan", out var timeSpanMillisecondsLong),
                    ...
                    ConvertSnippets.InvokeToInt64(timeSpanMillisecondsLong.As<TimeSpan>().TotalMilliseconds()).InvokeToString(invariantCulture)),
