    ...
    internal class MrwSerializationTypeDefinitionTests
    {
        ...
        public string TestDeserializeXmlValueCore_PrimitiveTypes(Type type, SerializationFormat format)
        {
            var expr = MrwSerializationTypeDefinition.DeserializeXmlValueCore(
                type,
                new ScopedApi<System.Xml.Linq.XElement>(new VariableExpression(typeof(System.Xml.Linq.XElement), "foo")),
                new ScopedApi<ModelReaderWriterOptions>(new VariableExpression(typeof(ModelReaderWriterOptions), "options")),
                format);
            return expr.ToDisplayString();
        }
        ...
        public string TestDeserializeXmlValueCore_DateTimeOffset(SerializationFormat format)
        {
            var expr = MrwSerializationTypeDefinition.DeserializeXmlValueCore(
        ...
        [TestCase(SerializationFormat.Duration_ISO8601, ExpectedResult = "foo.GetTimeSpan(\"P\")")]
        [TestCase(SerializationFormat.Duration_Constant, ExpectedResult = "foo.GetTimeSpan(\"c\")")]
        public string TestDeserializeXmlValueCore_TimeSpan(SerializationFormat format)
        {
            var expr = MrwSerializationTypeDefinition.DeserializeXmlValueCore(
                typeof(TimeSpan),
                new ScopedApi<System.Xml.Linq.XElement>(new VariableExpression(typeof(System.Xml.Linq.XElement), "foo")),
        ...
        public void TestSerializeXmlValueCore_Int()
        {
            var statement = MrwSerializationTypeDefinition.SerializeXmlValueCore(
                typeof(int),
                new VariableExpression(typeof(int), "value"),
                new ScopedApi<System.Xml.XmlWriter>(new VariableExpression(typeof(System.Xml.XmlWriter), "writer")),
                new ScopedApi<ModelReaderWriterOptions>(new VariableExpression(typeof(ModelReaderWriterOptions), "options")),
                SerializationFormat.Default);
            var result = statement.ToDisplayString();
            Assert.IsTrue(result.Contains("WriteValue"));
        ...
        public void TestSerializeXmlValueCore_String()
        {
            var statement = MrwSerializationTypeDefinition.SerializeXmlValueCore(
                typeof(string),
                new VariableExpression(typeof(string), "value"),
                new ScopedApi<System.Xml.XmlWriter>(new VariableExpression(typeof(System.Xml.XmlWriter), "writer")),
                new ScopedApi<ModelReaderWriterOptions>(new VariableExpression(typeof(ModelReaderWriterOptions), "options")),
                SerializationFormat.Default);
            var result = statement.ToDisplayString();
        ...
        [TestCase(SerializationFormat.DateTime_ISO8601)]
        [TestCase(SerializationFormat.DateTime_RFC1123)]
        public void TestSerializeXmlValueCore_DateTimeOffset(SerializationFormat format)
        {
            var statement = MrwSerializationTypeDefinition.SerializeXmlValueCore(
                typeof(DateTimeOffset),
                ...
                format);
            var result = statement.ToDisplayString();
            Assert.IsTrue(result.Contains("WriteStringValue"));
        }
