internal static global::Sample.Models.MockInputModel DeserializeMockInputModel(global::System.Text.Json.JsonElement element, global::System.ClientModel.Primitives.ModelReaderWriterOptions options)
{
    ...
    foreach (var prop in element.EnumerateObject())
    {
        if (prop.NameEquals("mockProperty"u8))
        {
            ...
            mockProperty = global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::System.IO.File>(prop.Value.GetUtf8Bytes(), options, global::Sample.SampleContext.Default);
            continue;
        }
        if ((options.Format != "W"))
        {
