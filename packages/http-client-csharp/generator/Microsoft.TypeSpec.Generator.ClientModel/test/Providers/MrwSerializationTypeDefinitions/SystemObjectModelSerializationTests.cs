...
namespace Microsoft.TypeSpec.Generator.ClientModel.Tests.Providers.MrwSerializationTypeDefinitions
{
    ...
    internal class SystemObjectModelSerializationTests
    {
        ...
        /// <summary>
        /// A stand-in for an external framework type generated by the MRW emitter. It declares the
        /// same protected virtual <c>*Core</c> methods that generated models expose, so reflection on
        /// it reports that the base participates in the serialization override chain.
        /// </summary>
        private class FakeMrwBase
        {
            protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
            {
            }

            protected virtual FakeMrwBase JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
                => this;

            protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
                => BinaryData.FromString(string.Empty);

            protected virtual FakeMrwBase PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
                => this;
        }
    }
}
