public virtual global::System.ClientModel.ClientResult<global::System.TimeSpan?> GetPlainTextDuration(global::System.Threading.CancellationToken cancellationToken = default)
{
    ...
    global::System.TimeSpan? value = (responseContent.Trim() == "null") ? ((global::System.TimeSpan?)null) : global::System.TimeSpan.FromSeconds(double.Parse(responseContent, global::System.Globalization.CultureInfo.InvariantCulture));
