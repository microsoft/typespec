public virtual global::System.ClientModel.ClientResult<global::Sample.Models.TestEnum?> GetEnum(global::System.Threading.CancellationToken cancellationToken = default)
{
    ...
    global::Sample.Models.TestEnum? value = (document.RootElement.ValueKind == global::System.Text.Json.JsonValueKind.Null) ? ((global::Sample.Models.TestEnum?)null) : document.RootElement.GetInt32().ToTestEnum();
