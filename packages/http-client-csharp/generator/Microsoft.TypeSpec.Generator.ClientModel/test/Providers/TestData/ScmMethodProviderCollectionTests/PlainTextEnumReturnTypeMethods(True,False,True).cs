public virtual global::System.ClientModel.ClientResult<global::Sample.Models.TestEnum?> GetPlainTextEnum(global::System.Threading.CancellationToken cancellationToken = default)
{
    ...
    global::Sample.Models.TestEnum? value = (result.GetRawResponse().Content.ToString().TrimStart('﻿') == "null") ? ((global::Sample.Models.TestEnum?)null) : result.GetRawResponse().Content.ToString().TrimStart('﻿').ToTestEnum();
