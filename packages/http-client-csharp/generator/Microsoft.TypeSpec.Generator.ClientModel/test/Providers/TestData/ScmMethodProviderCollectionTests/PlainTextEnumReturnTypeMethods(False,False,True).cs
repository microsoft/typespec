public virtual global::System.ClientModel.ClientResult<global::Sample.Models.TestEnum?> GetPlainTextEnum(global::System.Threading.CancellationToken cancellationToken = default)
{
    ...
    global::Sample.Models.TestEnum? value = (responseContent.Trim() == "null") ? ((global::Sample.Models.TestEnum?)null) : int.Parse(responseContent, global::System.Globalization.CultureInfo.InvariantCulture).ToTestEnum();
