...
namespace Sample
{
    public partial class TestClient
    {
        public virtual async global::System.Threading.Tasks.Task<global::System.ClientModel.ClientResult> TestOperationAsync(global::Sample.Models.ModelWithPathParam body, global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await this.TestOperationAsync(body.Cat, body.Dog, body.Bird, body, cancellationToken.CanBeCanceled ? new global::System.ClientModel.Primitives.RequestOptions { CancellationToken = cancellationToken } : null).ConfigureAwait(false);
        }
    }
}
