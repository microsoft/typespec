...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public void PreVisitsMethods()
        {
            ...
            _mockVisitor.Protected().Verify<ScmClientMethodProviderCollection>("Visit", Times.Once(), inputServiceMethod, ItExpr.IsAny<ClientProvider>(), ItExpr.IsAny<ScmClientMethodProviderCollection>());
        }
