...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        private PropertyProvider(InputProperty inputProperty, CSharpType propertyType, TypeProvider enclosingType)
        {
            ...
            Name = GetPropertyName(inputProperty, enclosingType, Type);
            ...
            CSharpType? propertyType = null)
        {
            ...
            if (!inputProperty.IsExactName)
            {
                    ...
                    !identifierName.EndsWith("On", StringComparison.Ordinal))
                {
                    ...
                    propertyType ??= CodeModelGenerator.Instance.TypeFactory.CreateCSharpType(inputProperty.Type);
                    if (inputProperty.IsReadOnly && propertyType is not null)
                    {
                        propertyType = propertyType.OutputType;
                    }
                    previousProperty = specStem is null || propertyType is null
                        ? null
                        : lastContractProperties?.FirstOrDefault(p =>
            ...
            return AvoidPropertyNameCollision(identifierName, enclosingType.Name);
        }
