    ...
    public class ModelCustomizationTests
    {
        ...
        public async Task CustomCodeReplacesDateNormalizedProperty()
        {
            ...
            var inputModel = InputFactory.Model(
                "mockInputModel",
                properties: [InputFactory.Property("creationDate", dateTime, isRequired: true, normalizedName: "CreatedOn")]);
        ...
        public async Task CustomCodeWithRawDateTimeNameReplacesNormalizedProperty()
        {
            ...
            var inputModel = InputFactory.Model(
                "mockInputModel",
                properties: [InputFactory.Property("valueDate", dateTime, normalizedName: "ValueOn")]);
        ...
        public async Task CustomCodeRenameWithNameMatchingAnotherSpecPropertyDoesNotSuppressIt()
        {
            ...
            var inputModel = InputFactory.Model(
                ...
                [
                    ...
                    InputFactory.Property("valueDate", dateTime, isRequired: true, normalizedName: "ValueOn")
                ]);
        ...
        public async Task DuplicateExactIdentifierCustomizationSuppressesOnlyFirstSpecMatch()
        {
            ...
            var inputModel = InputFactory.Model(
                ...
                [
                    InputFactory.Property("start_time", InputPrimitiveType.String, wireName: "firstWireName"),
                    InputFactory.Property("startTime", dateTime, wireName: "secondWireName", normalizedName: "StartsOn")
                ]);
        ...
        public async Task RefilteringDoesNotUseStaleAliasToSuppressActiveProperty()
        {
            ...
            var inputModel = InputFactory.Model(
                ...
                properties:
                [
                    InputFactory.Property("startTime", dateTime, normalizedName: "StartsOn"),
        ...
        public async Task ExactSpecNameTakesPrecedenceOverCanonicalAliasForCustomization()
        {
            ...
            var inputModel = InputFactory.Model(
                ...
                properties:
                [
                    InputFactory.Property("startTime", dateTime, wireName: "startTime", isRequired: true, normalizedName: "StartsOn"),
        ...
        public async Task CustomCodeReplacesAcronymNormalizedProperty()
        {
            var inputModel = InputFactory.Model(
                "mockInputModel",
                properties: [InputFactory.Property("ipFoo", InputPrimitiveType.String, isRequired: true, normalizedName: "IPFoo")]);
