    ...
    public class ModelProviderTests
    {
        ...
        public async Task TestBuildName_BackCompatTakesPrecedenceOverAcronymNormalization()
        {
            var inputModel = InputFactory.Model(
                "IpAddress",
                normalizedName: "IPAddress",
                properties:
                [
                    InputFactory.Property("dbName", InputPrimitiveType.String, normalizedName: "DBName"),
                    InputFactory.Property("osProfile", InputPrimitiveType.String, normalizedName: "OSProfile"),
                    InputFactory.Property("IpAddress", InputPrimitiveType.String, normalizedName: "IPAddress")
                ]);
        ...
        public void ExternalTypePropertyIsResolved()
        {
            ...
            var model = InputFactory.Model(
                ...
                properties:
                [
                    InputFactory.Property("ipAddress", externalType, normalizedName: "IPAddress"),
                    InputFactory.Property("name", InputPrimitiveType.String)
                ]);
