        ...
        private class TestTypeProvider : TypeProvider
        {
            ...
            private static InputType GetSpecType()
            {
                ...
                [
                    ...
                    new InputModelProperty("NullWireInfoProperty", null, null, InputPrimitiveType.String, false, false, null, false, "NullWireInfoProperty", false, false, null, new InputSerializationOptions(), null, [])
                ];
