...
{
    internal sealed class TypeSpecInputXmlSerializationOptionsConverter : JsonConverter<InputXmlSerializationOptions>
    {
        private readonly TypeSpecReferenceHandler _referenceHandler;

        public TypeSpecInputXmlSerializationOptionsConverter(TypeSpecReferenceHandler referenceHandler)
        {
