...
namespace Microsoft.TypeSpec.Generator.Input
{
    public class InputClient
    {
        ...
        public InputClient(
            ...
            IReadOnlyList<InputOperation> operations,
        ...
        public InputClient() : this(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, Array.Empty<InputServiceMethod>(), Array.Empty<InputOperation>(), Array.Empty<InputParameter>(), null, null) { }
