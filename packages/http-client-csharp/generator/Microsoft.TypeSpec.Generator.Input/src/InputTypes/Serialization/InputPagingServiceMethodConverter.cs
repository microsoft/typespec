...
{
    internal sealed class InputPagingServiceMethodConverter : JsonConverter<InputPagingServiceMethod>
    {
        private readonly TypeSpecReferenceHandler _referenceHandler;

        public InputPagingServiceMethodConverter(TypeSpecReferenceHandler referenceHandler)
        {
