...
{
    internal sealed class InputPrimitiveTypeConverter : JsonConverter<InputPrimitiveType>
    {
        private readonly TypeSpecReferenceHandler _referenceHandler;

        public InputPrimitiveTypeConverter(TypeSpecReferenceHandler referenceHandler)
        {
