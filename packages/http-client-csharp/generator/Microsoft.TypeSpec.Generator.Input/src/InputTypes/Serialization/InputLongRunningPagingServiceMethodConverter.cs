...
{
    internal sealed class InputLongRunningPagingServiceMethodConverter : JsonConverter<InputLongRunningPagingServiceMethod>
    {
        private readonly TypeSpecReferenceHandler _referenceHandler;

        public InputLongRunningPagingServiceMethodConverter(TypeSpecReferenceHandler referenceHandler)
        {
