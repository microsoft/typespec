...
{
    internal sealed class TypeSpecInputLongRunningServiceMethodConverter : JsonConverter<InputLongRunningServiceMethod>
    {
        private readonly TypeSpecReferenceHandler _referenceHandler;

        public TypeSpecInputLongRunningServiceMethodConverter(TypeSpecReferenceHandler referenceHandler)
        {
