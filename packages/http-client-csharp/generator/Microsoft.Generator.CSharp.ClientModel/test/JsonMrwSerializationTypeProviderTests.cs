...
namespace Microsoft.Generator.CSharp.ClientModel.Tests
{
    internal class JsonMrwSerializationTypeProviderTests
    {
        ...
        public void TestBuildSerializationConstructor(CSharpMethod? baseCtor)
        {
            ...
            var mockModelTypeProvider = new ModelTypeProvider(inputModel, null);
            var jsonMrwSerializationTypeProvider = new JsonMrwSerializationTypeProvider(mockModelTypeProvider);
            var constructor = jsonMrwSerializationTypeProvider.BuildSerializationConstructor(baseCtor);
        ...
        public void TestBuildFields()
        {
            ...
            var typeProvider = new JsonMrwSerializationTypeProvider(model);
        ...
        public void TestBuildConstructor_ValidateConstructors()
        {
            ...
            var serializationModelTypeProvider = new JsonMrwSerializationTypeProvider(modelTypeProvider);
