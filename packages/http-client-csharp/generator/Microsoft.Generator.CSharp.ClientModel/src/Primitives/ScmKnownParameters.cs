...
namespace Microsoft.Generator.CSharp.ClientModel.Primitives
{
    ...
    {
        private const string KeyCredentialFieldName = "_keyCredential";
        ...
        public static readonly ParameterProvider ApiKeyAuth = new ParameterProvider(
            "credential",
            $"A credential used to authenticate to the service.",
            typeof(ApiKeyCredential),
            field: new(FieldModifiers.Private | FieldModifiers.ReadOnly, typeof(ApiKeyCredential), KeyCredentialFieldName)
        )
        {
