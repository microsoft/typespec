...
namespace Microsoft.Generator.CSharp.ClientModel.Snippets
{
    internal static class JsonElementSnippets
    {
        ...
        public static ScopedApi<bool> TryGetInt32(this ScopedApi<JsonElement> jsonElement, out ScopedApi<int> intValue)
        {
            ...
            var invocation = new InvokeInstanceMethodExpression(jsonElement, nameof(JsonElement.TryGetInt32), [new DeclarationExpression(intValueDeclaration, true)], null, false);
            return invocation.As<bool>();
        }
        ...
        public static ScopedApi<bool> TryGetInt64(this ScopedApi<JsonElement> jsonElement, out ScopedApi<long> longValue)
        {
            ...
            var invocation = new InvokeInstanceMethodExpression(jsonElement, nameof(JsonElement.TryGetInt64), [new DeclarationExpression(longValueDeclaration, true)], null, false);
            return invocation.As<bool>();
        }
    }
}
