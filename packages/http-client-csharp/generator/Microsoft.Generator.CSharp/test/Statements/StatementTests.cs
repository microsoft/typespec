...
namespace Microsoft.Generator.CSharp.Tests.Statements
{
    public class StatementTests
    {
        ...
        public void TestSwitchStatementWithMultipleCasesWrite()
        {
            ...
            var expectedResult = File.ReadAllText(Path.Combine(_testDataPath, "SwitchCaseStatement.txt"));
        ...
        public void TestSwitchStatementWithUsingStatementWrite()
        {
            ...
            var expectedResult = File.ReadAllText(Path.Combine(_testDataPath, "SwitchCaseStatementWithUsing.txt"));
            var test = writer.ToString();
            Assert.AreEqual(expectedResult, test);
        }
        ...
        public void TestIfElsePreprocessorStatement()
        {
            ...
            var expectedResult = File.ReadAllText(Path.Combine(_testDataPath, "IfElsePreprocessorStatement.txt"));
            var test = writer.ToString();
            Assert.AreEqual(expectedResult, test);
        }
    }
