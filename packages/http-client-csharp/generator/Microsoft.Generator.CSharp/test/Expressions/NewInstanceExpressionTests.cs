...
namespace Microsoft.Generator.CSharp.Tests.Expressions
{
    internal class NewInstanceExpressionTests
    {
        ...
        {
            InputEnumType enumType = new InputEnumType("MyEnum", "MyEnum", "public", null, "MyEnum", InputModelTypeUsage.RoundTrip, InputPrimitiveType.String, [new InputEnumTypeValue("One", "one", null), new InputEnumTypeValue("Two", "two", null)], true);
