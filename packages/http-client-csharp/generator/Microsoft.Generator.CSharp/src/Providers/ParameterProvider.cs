...
namespace Microsoft.Generator.CSharp.Providers
{
    ...
    public sealed class ParameterProvider : IEquatable<ParameterProvider>
    {
        ...
        public ParameterProvider(InputParameter inputParameter)
        {
            ...
            Type = CodeModelPlugin.Instance.TypeFactory.CreatePrimitiveCSharpType(inputParameter.Type) ?? throw new InvalidOperationException($"Failed to create CSharpType for {inputParameter.Type}");
