...
{
    public sealed record VariableReferenceSnippet(CSharpType Type, CodeWriterDeclaration Declaration) : TypedSnippet(Type, new FormattableStringExpression($"{Declaration:I}"))
    {
