...
namespace Microsoft.Generator.CSharp.Snippets
{
    public sealed record EnumerableSnippet(CSharpType ItemType, ValueExpression Expression) : TypedSnippet(new CSharpType(typeof(IEnumerable<>), false, ItemType), Expression)
    {
        ...
        public EnumerableSnippet Select(ScopedApi selector) => new(selector.Type, new InvokeStaticMethodExpression(typeof(Enumerable), nameof(Enumerable.Select), new[] { Expression, selector }, CallAsExtension: true));
    }
}
