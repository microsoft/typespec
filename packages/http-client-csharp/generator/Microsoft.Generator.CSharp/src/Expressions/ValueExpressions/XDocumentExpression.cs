...
{
    public sealed record XDocumentExpression(ValueExpression Untyped) : TypedValueExpression<XDocument>(Untyped), ITypedValueExpressionFactory<XDocumentExpression>
    {
        ...
        static XDocumentExpression ITypedValueExpressionFactory<XDocumentExpression>.Create(ValueExpression untyped)
            => new(untyped);
    }
}
