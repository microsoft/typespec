...
{
    public sealed record LongExpression(ValueExpression Untyped) : TypedValueExpression<long>(Untyped), ITypedValueExpressionFactory<LongExpression>
    {
        ...
        static LongExpression ITypedValueExpressionFactory<LongExpression>.Create(ValueExpression untyped)
            => new(untyped);
    }
}
