...
namespace Microsoft.Generator.CSharp.Primitives
{
    ...
    public abstract record MethodSignatureBase(string Name, FormattableString? Description, string? NonDocumentComment, MethodSignatureModifiers Modifiers, IReadOnlyList<ParameterProvider> Parameters, IReadOnlyList<AttributeStatement> Attributes);
}
