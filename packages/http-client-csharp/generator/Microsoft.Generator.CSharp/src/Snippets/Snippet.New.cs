...
namespace Microsoft.Generator.CSharp.Snippets
{
    public static partial class Snippet
    {
        public static class New
        {
            ...
            public static ScopedApi<T> Instance<T>(IEnumerable<ValueExpression> arguments, IReadOnlyDictionary<ValueExpression, ValueExpression> properties, bool useSingleLineForPropertyInitialization)
