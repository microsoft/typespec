...
namespace Microsoft.Generator.CSharp.Snippets
{
    public static partial class Snippet
    {
        ...
        public static ScopedApi<T> NullConditional<T>(this ScopedApi<T> valueExpression) => valueExpression.Original.NullConditional().As<T>();

        public static ValueExpression NullConditional(this ValueExpression valueExpression) => new NullConditionalExpression(valueExpression);
