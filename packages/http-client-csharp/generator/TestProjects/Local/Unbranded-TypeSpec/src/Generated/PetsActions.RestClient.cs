...
namespace UnbrandedTypeSpec
{
    ...
    public partial class PetsActions
    {
        ...
        internal PipelineMessage CreateFeedRequest(string id, RequestOptions options)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/pets/actions/", false);
        ...
        internal PipelineMessage CreatePetRequest(string id, RequestOptions options)
        {
            PipelineMessage message = Pipeline.CreateMessage();
            message.ResponseClassifier = PipelineMessageClassifier204;
            PipelineRequest request = message.Request;
