...
namespace UnbrandedTypeSpec
{
    ...
    {
        private const Versions LatestVersion = Versions.V2024_08_16_Preview;

        /// <summary> Initializes a new instance of UnbrandedTypeSpecClientOptions. </summary>
        /// <param name="version"> The service version. </param>
        public UnbrandedTypeSpecClientOptions(Versions version = LatestVersion)
        {
            Version = version switch
            {
                Versions.V2024_07_16_Preview => "2024-07-16-preview",
                Versions.V2024_08_16_Preview => "2024-08-16-preview",
