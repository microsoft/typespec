...
namespace UnbrandedTypeSpec.Models
{
    ...
    public partial class ModelWithBaseModelWithoutRequired : IJsonModel<ModelWithBaseModelWithoutRequired>
    {
        ...
        internal ModelWithBaseModelWithoutRequired(string name, string address, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Address = address;
        ...
        internal static ModelWithBaseModelWithoutRequired DeserializeModelWithBaseModelWithoutRequired(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ModelWithBaseModelWithoutRequired(name, address, serializedAdditionalRawData);
        }
        ...
        ModelWithBaseModelWithoutRequired IPersistableModel<ModelWithBaseModelWithoutRequired>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ModelWithBaseModelWithoutRequired PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ModelWithBaseModelWithoutRequired>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
