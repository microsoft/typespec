...
namespace SampleTypeSpec
{
    internal static partial class TypeFormatters
    {
        ...
        {
            string formatSpecifier = TypeFormatters.ToFormatSpecifier(format);
            ...
            return value switch
            {
                ...
                Byte[] b0 when (formatSpecifier != null) => TypeFormatters.ToString(b0, formatSpecifier),
                IEnumerable<string> s0 => string.Join(",", s0),
                DateTimeOffset dateTime when (formatSpecifier != null) => TypeFormatters.ToString(dateTime, formatSpecifier),
                ...
                TimeSpan timeSpan5 when (formatSpecifier != null) => TypeFormatters.ToString(timeSpan5, formatSpecifier),
