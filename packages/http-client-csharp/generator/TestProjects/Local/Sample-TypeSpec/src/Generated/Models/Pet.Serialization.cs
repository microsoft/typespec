...
#pragma warning disable SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            ...
            if (Optional.IsDefined(Weight) && !Patch.Contains("$.weight"u8))
            {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static Pet DeserializePet(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("kind"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "cat":
                        return Cat.DeserializeCat(element, data, options);
                    case "dog":
                        return Dog.DeserializeDog(element, data, options);
                }
            }
            return UnknownPet.DeserializeUnknownPet(element, data, options);
        }
