...
{
    internal partial class SampleTypeSpecClientGetWithContinuationTokenHeaderResponseAsyncCollectionResultOfT : global::System.ClientModel.AsyncCollectionResult<global::SampleTypeSpec.Thing>
    {
        ...
        public SampleTypeSpecClientGetWithContinuationTokenHeaderResponseAsyncCollectionResultOfT(global::SampleTypeSpec.SampleTypeSpecClient client, string token, global::System.ClientModel.Primitives.RequestOptions options)
        {
            _client = client;
            _token = token;
            _options = options;
        ...
        {
            foreach (global::SampleTypeSpec.Thing item in ((global::SampleTypeSpec.ListWithContinuationTokenHeaderResponseResponse)page).Things)
            {
                yield return item;
