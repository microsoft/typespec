...
namespace SampleTypeSpec
{
    ...
    public partial class SampleTypeSpecClient
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> or <paramref name="requiredBadDescription"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<Thing>> AnonymousBodyAsync(string name, BinaryData requiredUnion, string requiredNullableString, ThingRequiredNullableLiteralString1? requiredNullableLiteralString, string requiredBadDescription, IEnumerable<int> requiredNullableList, string optionalNullableString = default, ThingOptionalLiteralString? optionalLiteralString = default, ThingOptionalLiteralInt? optionalLiteralInt = default, ThingOptionalLiteralFloat? optionalLiteralFloat = default, bool? optionalLiteralBool = default, IEnumerable<int> optionalNullableList = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(requiredUnion, nameof(requiredUnion));
            Argument.AssertNotNullOrEmpty(requiredBadDescription, nameof(requiredBadDescription));
        ...
        public virtual ClientResult DynamicModelWithBaseOperation(DynamicModelWithBase body, CancellationToken cancellationToken = default)
        {
            ...
            return DynamicModelWithBaseOperation(body, cancellationToken.ToRequestOptions());
        }
        ...
        public virtual async Task<ClientResult> DynamicModelWithBaseOperationAsync(DynamicModelWithBase body, CancellationToken cancellationToken = default)
        {
            ...
            return await DynamicModelWithBaseOperationAsync(body, cancellationToken.ToRequestOptions()).ConfigureAwait(false);
        }
        ...
        public virtual ClientResult<DynamicModelWithBase> AnimalModelOperation(Animal body, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = AnimalModelOperation(body, cancellationToken.ToRequestOptions());
        ...
        public virtual async Task<ClientResult<DynamicModelWithBase>> AnimalModelOperationAsync(Animal body, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await AnimalModelOperationAsync(body, cancellationToken.ToRequestOptions()).ConfigureAwait(false);
            return ClientResult.FromValue((DynamicModelWithBase)result, result.GetRawResponse());
        }
    }
}
