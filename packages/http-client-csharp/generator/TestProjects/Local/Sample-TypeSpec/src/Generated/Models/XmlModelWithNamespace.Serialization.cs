...
namespace SampleTypeSpec
{
    ...
    public partial class XmlModelWithNamespace : IPersistableModel<XmlModelWithNamespace>
    {
        ...
        protected virtual XmlModelWithNamespace PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "X":
                    ...
                    {
                        return XmlModelWithNamespace.DeserializeXmlModelWithNamespace(XElement.Load(dataStream, LoadOptions.PreserveWhitespace), options);
                    }
                default:
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<XmlModelWithNamespace>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        XmlModelWithNamespace IPersistableModel<XmlModelWithNamespace>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);
