...
namespace SampleTypeSpec
{
    ...
    public partial class GetNotebookResponse : IJsonModel<global::SampleTypeSpec.GetNotebookResponse>
    {
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::SampleTypeSpec.GetNotebookResponse>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::SampleTypeSpec.GetNotebookResponse>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GetNotebookResponse IPersistableModel<global::SampleTypeSpec.GetNotebookResponse>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::SampleTypeSpec.GetNotebookResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::SampleTypeSpec.GetNotebookResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GetNotebookResponse IJsonModel<global::SampleTypeSpec.GetNotebookResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);
