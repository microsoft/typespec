...
namespace SampleTypeSpec
{
    internal partial class SampleTypeSpecClientGetWithContinuationTokenCollectionResult : CollectionResult
    {
        ...
        public SampleTypeSpecClientGetWithContinuationTokenCollectionResult(SampleTypeSpecClient client, ModelReaderWriterOptions modelReaderWriterOptions, string token, RequestOptions options)
        {
            _client = client;
