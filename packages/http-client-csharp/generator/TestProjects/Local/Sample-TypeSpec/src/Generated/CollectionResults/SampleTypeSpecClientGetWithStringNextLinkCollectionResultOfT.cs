...
namespace SampleTypeSpec
{
    internal partial class SampleTypeSpecClientGetWithStringNextLinkCollectionResultOfT : CollectionResult<Thing>
    {
        ...
        public SampleTypeSpecClientGetWithStringNextLinkCollectionResultOfT(SampleTypeSpecClient client, RequestOptions options, ActivitySource activitySource = null)
        {
            _client = client;
            _options = options;
