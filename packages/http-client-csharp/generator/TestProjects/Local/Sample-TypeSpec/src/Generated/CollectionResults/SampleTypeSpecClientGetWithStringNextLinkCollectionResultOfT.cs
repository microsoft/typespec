...
namespace SampleTypeSpec
{
    internal partial class SampleTypeSpecClientGetWithStringNextLinkCollectionResultOfT : CollectionResult<Thing>
    {
        ...
        public SampleTypeSpecClientGetWithStringNextLinkCollectionResultOfT(SampleTypeSpecClient client, ModelReaderWriterOptions modelReaderWriterOptions, RequestOptions options)
        {
            _client = client;
        ...
        {
            return ModelReaderWriter.Read<ListWithStringNextLinkResponse>(page.GetRawResponse().Content, _modelReaderWriterOptions, SampleTypeSpecContext.Default).Things;
        }
