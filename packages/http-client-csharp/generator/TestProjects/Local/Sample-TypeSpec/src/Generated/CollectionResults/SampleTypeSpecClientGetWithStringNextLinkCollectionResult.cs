...
{
    internal partial class SampleTypeSpecClientGetWithStringNextLinkCollectionResult : global::System.ClientModel.Primitives.CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of SampleTypeSpecClientGetWithStringNextLinkCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The SampleTypeSpecClient client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public SampleTypeSpecClientGetWithStringNextLinkCollectionResult(global::SampleTypeSpec.SampleTypeSpecClient client, global::System.ClientModel.Primitives.RequestOptions options)
        {
            _client = client;
            _options = options;
        }
