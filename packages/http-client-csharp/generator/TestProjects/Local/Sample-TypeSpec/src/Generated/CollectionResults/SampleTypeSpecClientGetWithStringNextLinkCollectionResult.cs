...
namespace SampleTypeSpec
{
    internal partial class SampleTypeSpecClientGetWithStringNextLinkCollectionResult : CollectionResult
    {
        ...
        public SampleTypeSpecClientGetWithStringNextLinkCollectionResult(SampleTypeSpecClient client, RequestOptions options, ActivitySource activitySource = null)
        {
            _client = client;
            _options = options;
