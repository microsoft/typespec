...
namespace SampleTypeSpec
{
    ...
    public partial class PetOperations
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="pet"/> is null. </exception>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<global::SampleTypeSpec.Pet>> UpdatePetAsPetAsync(Pet pet, CancellationToken cancellationToken = default)
        {
            global::SampleTypeSpec.Argument.AssertNotNull(pet, nameof(pet));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="pet"/> is null. </exception>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<global::SampleTypeSpec.Pet>> UpdateDogAsPetAsync(Pet pet, CancellationToken cancellationToken = default)
        {
            global::SampleTypeSpec.Argument.AssertNotNull(pet, nameof(pet));
