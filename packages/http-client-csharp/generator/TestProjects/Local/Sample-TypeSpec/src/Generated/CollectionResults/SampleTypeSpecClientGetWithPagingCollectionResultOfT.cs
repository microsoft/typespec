...
namespace SampleTypeSpec
{
    internal partial class SampleTypeSpecClientGetWithPagingCollectionResultOfT : CollectionResult<Thing>
    {
        ...
        public SampleTypeSpecClientGetWithPagingCollectionResultOfT(SampleTypeSpecClient client, RequestOptions options, ActivitySource activitySource = null)
        {
            _client = client;
            _options = options;
        ...
        public override IEnumerable<ClientResult> GetRawPages()
        {
            ...
            yield return ExecutePageRequest(message);
        }
