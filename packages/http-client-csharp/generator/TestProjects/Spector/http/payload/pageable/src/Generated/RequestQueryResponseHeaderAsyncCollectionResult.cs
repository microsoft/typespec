...
{
    internal partial class RequestQueryResponseHeaderAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public RequestQueryResponseHeaderAsyncCollectionResult(ServerDrivenPaginationContinuationToken client, string token, string foo, string bar, RequestOptions options)
        {
            _client = client;
            _token = token;
            _foo = foo;
