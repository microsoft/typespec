...
namespace Payload.Pageable._ServerDrivenPagination.ContinuationToken
{
    public partial class ServerDrivenPaginationContinuationToken
    {
        ...
        public virtual CollectionResult RequestQueryNestedResponseBody(string token = default, string foo = default, string bar = default, CancellationToken cancellationToken = default) => throw null;

        public virtual AsyncCollectionResult RequestQueryNestedResponseBodyAsync(string token = default, string foo = default, string bar = default, CancellationToken cancellationToken = default) => throw null;
        ...
        public virtual CollectionResult RequestHeaderNestedResponseBody(string token = default, string foo = default, string bar = default, CancellationToken cancellationToken = default) => throw null;

        public virtual AsyncCollectionResult RequestHeaderNestedResponseBodyAsync(string token = default, string foo = default, string bar = default, CancellationToken cancellationToken = default) => throw null;
    }
}
