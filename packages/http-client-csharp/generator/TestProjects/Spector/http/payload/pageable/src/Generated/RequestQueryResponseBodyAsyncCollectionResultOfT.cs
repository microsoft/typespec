...
{
    internal partial class RequestQueryResponseBodyAsyncCollectionResultOfT : AsyncCollectionResult<Pet>
    {
        ...
        public RequestQueryResponseBodyAsyncCollectionResultOfT(ServerDrivenPaginationContinuationToken client, string token, string foo, string bar, RequestOptions options)
        {
            _client = client;
            _token = token;
            _foo = foo;
