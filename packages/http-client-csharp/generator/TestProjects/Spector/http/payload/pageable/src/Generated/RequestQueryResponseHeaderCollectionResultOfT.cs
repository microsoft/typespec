...
{
    internal partial class RequestQueryResponseHeaderCollectionResultOfT : CollectionResult<Pet>
    {
        ...
        public RequestQueryResponseHeaderCollectionResultOfT(ServerDrivenPaginationContinuationToken client, string token, string foo, string bar, RequestOptions options)
        {
            _client = client;
            _token = token;
            _foo = foo;
