...
{
    internal partial class RequestQueryResponseBodyCollectionResult : CollectionResult
    {
        ...
        public RequestQueryResponseBodyCollectionResult(ServerDrivenPaginationContinuationToken client, string token, string foo, string bar, RequestOptions options)
        {
            _client = client;
            _token = token;
            _foo = foo;
