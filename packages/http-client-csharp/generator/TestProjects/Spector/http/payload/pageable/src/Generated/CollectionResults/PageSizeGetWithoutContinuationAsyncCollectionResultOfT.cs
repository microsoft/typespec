...
{
    internal partial class PageSizeGetWithoutContinuationAsyncCollectionResultOfT : AsyncCollectionResult<Pet>
    {
        private readonly PageSize _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of PageSizeGetWithoutContinuationAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The PageSize client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public PageSizeGetWithoutContinuationAsyncCollectionResultOfT(PageSize client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
        ...
        {
            foreach (Pet item in ((ListWithoutContinuationResponse)page).Pets)
            {
                yield return item;
                await Task.Yield();
            }
