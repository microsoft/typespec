...
{
    internal partial class RequestQueryResponseHeaderCollectionResult : CollectionResult
    {
        ...
        public RequestQueryResponseHeaderCollectionResult(ServerDrivenPaginationContinuationToken client, string token, string foo, string bar, RequestOptions options)
        {
            _client = client;
            _token = token;
            _foo = foo;
