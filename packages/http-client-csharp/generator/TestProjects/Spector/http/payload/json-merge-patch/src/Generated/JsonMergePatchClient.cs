...
namespace Payload.JsonMergePatch
{
    public partial class JsonMergePatchClient
    {
        ...
        public virtual ClientResult UpdateOptionalResource(BinaryContent content = default, RequestOptions options = null) => throw null;

        public virtual Task<ClientResult> UpdateOptionalResourceAsync(BinaryContent content = default, RequestOptions options = null) => throw null;
    }
}
