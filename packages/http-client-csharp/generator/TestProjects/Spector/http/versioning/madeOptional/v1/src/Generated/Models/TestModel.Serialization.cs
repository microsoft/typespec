...
namespace Versioning.MadeOptional
{
    ...
    public partial class TestModel : IJsonModel<TestModel>
    {
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, VersioningMadeOptionalV1Context.Default);
                default:
        ...
        public static implicit operator BinaryContent(TestModel testModel)
        {
            if (testModel == null)
            {
                return null;
            }
            return BinaryContent.Create(testModel, ModelSerializationExtensions.WireOptions);
        }
