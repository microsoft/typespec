...
namespace Versioning.MadeOptional
{
    public partial class MadeOptionalClient
    {
        ...
        public virtual Task<ClientResult<global::Versioning.MadeOptional.TestModel>> TestAsync(string @param, TestModel body, CancellationToken cancellationToken = default) => throw null;
    }
}
