...
namespace Versioning.RenamedFrom
{
    ...
    public partial class NewModel : IJsonModel<NewModel>
    {
        ...
        public static implicit operator BinaryContent(NewModel newModel)
        {
            if (newModel == null)
            {
                return null;
            }
            return BinaryContent.Create(newModel, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="NewModel"/> from. </param>
        public static explicit operator NewModel(ClientResult result)
        {
