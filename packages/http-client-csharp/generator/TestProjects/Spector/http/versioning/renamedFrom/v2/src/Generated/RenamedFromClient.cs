...
namespace Versioning.RenamedFrom
{
    public partial class RenamedFromClient
    {
        ...
        public virtual Task<ClientResult<global::Versioning.RenamedFrom.NewModel>> NewOpAsync(string newQuery, NewModel body, CancellationToken cancellationToken = default) => throw null;
