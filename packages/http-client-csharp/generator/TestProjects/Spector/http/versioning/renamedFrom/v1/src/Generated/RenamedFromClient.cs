...
namespace Versioning.RenamedFrom
{
    public partial class RenamedFromClient
    {
        ...
        public virtual Task<ClientResult<global::Versioning.RenamedFrom.OldModel>> OldOpAsync(string oldQuery, OldModel body, CancellationToken cancellationToken = default) => throw null;
