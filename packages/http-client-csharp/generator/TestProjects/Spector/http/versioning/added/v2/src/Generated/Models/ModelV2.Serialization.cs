...
namespace Versioning.Added
{
    ...
    public partial class ModelV2 : IJsonModel<ModelV2>
    {
        ...
        public static implicit operator BinaryContent(ModelV2 modelV2)
        {
            if (modelV2 == null)
            {
                return null;
            }
            return BinaryContent.Create(modelV2, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="ModelV2"/> from. </param>
        public static explicit operator ModelV2(ClientResult result)
        {
