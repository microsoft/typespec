...
namespace Authentication.Http.Custom
{
    ...
    public partial class CustomClient
    {
        ...
        public CustomClient(ApiKeyCredential keyCredential) : this(new Uri("http://localhost:3000"), keyCredential, new CustomClientOptions())
        {
        }
        ...
        public CustomClient(Uri endpoint, ApiKeyCredential keyCredential, CustomClientOptions options)
        {
