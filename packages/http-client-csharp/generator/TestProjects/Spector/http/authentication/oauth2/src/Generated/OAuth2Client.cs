...
namespace Authentication.OAuth2
{
    public partial class OAuth2Client
    {
        ...
        public OAuth2Client(AuthenticationTokenProvider tokenProvider) => throw null;

        public OAuth2Client(AuthenticationTokenProvider tokenProvider, OAuth2ClientOptions options) => throw null;

        public OAuth2Client(Uri endpoint, AuthenticationTokenProvider tokenProvider, OAuth2ClientOptions options) => throw null;

        [Experimental("SCME0002")]
        public OAuth2Client(OAuth2ClientSettings settings) => throw null;
