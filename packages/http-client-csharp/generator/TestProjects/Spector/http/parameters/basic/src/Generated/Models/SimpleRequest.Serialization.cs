...
namespace Parameters.Basic._ImplicitBody
{
    ...
    internal partial class SimpleRequest : IJsonModel<SimpleRequest>
    {
        ...
        /// <param name="simpleRequest"> The <see cref="SimpleRequest"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(SimpleRequest simpleRequest)
        {
            if (simpleRequest == null)
            {
                return null;
            }
            return BinaryContent.Create(simpleRequest, ModelSerializationExtensions.WireOptions);
        }
    }
}
