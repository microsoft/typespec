...
namespace Parameters.Path
{
    public partial class PathClient
    {
        ...
        public virtual ClientResult Optional(string name, CancellationToken cancellationToken = default) => throw null;

        public virtual Task<ClientResult> OptionalAsync(string name, CancellationToken cancellationToken = default) => throw null;
    }
}
