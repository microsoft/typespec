...
namespace _Type.Property.AdditionalProperties
{
    ...
    public static partial class TypePropertyAdditionalPropertiesModelFactory
    {
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="AdditionalProperties.ExtendsUnknownAdditionalPropertiesDiscriminatedDerived"/>.
        /// </summary>
        /// <param name="name"> The name property. </param>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="AdditionalProperties.IsUnknownAdditionalPropertiesDiscriminatedDerived"/>.
        /// </summary>
        /// <param name="name"> The name property. </param>
        /// <param name="kind"> The discriminator. </param>
        /// <param name="additionalProperties"></param>
        ...
        public static WidgetData0 WidgetData0(string fooProp = default)
        {
            return new WidgetData0("kind0", fooProp, additionalBinaryDataProperties: null);
        }
        ...
        public static WidgetData1 WidgetData1(DateTimeOffset start = default, DateTimeOffset? end = default)
        {
            return new WidgetData1("kind1", start, end, additionalBinaryDataProperties: null);
        }
        ...
        public static WidgetData2 WidgetData2(string start = default)
        {
            return new WidgetData2("kind1", start, additionalBinaryDataProperties: null);
        }
