...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class MultipleSpreadRecord
    {
        ...
        internal MultipleSpreadRecord(bool flag, IDictionary<string, string> additionalProperties, IDictionary<string, float> additionalSingleProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Flag = flag;
