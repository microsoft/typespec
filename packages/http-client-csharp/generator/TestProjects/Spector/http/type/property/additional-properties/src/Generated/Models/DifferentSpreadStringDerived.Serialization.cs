...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class DifferentSpreadStringDerived : DifferentSpreadStringRecord, IJsonModel<DifferentSpreadStringDerived>
    {
        ...
        public static implicit operator BinaryContent(DifferentSpreadStringDerived differentSpreadStringDerived)
        {
            if (differentSpreadStringDerived == null)
            {
                return null;
            }
            return BinaryContent.Create(differentSpreadStringDerived, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="DifferentSpreadStringDerived"/> from. </param>
        public static explicit operator DifferentSpreadStringDerived(ClientResult result)
        {
