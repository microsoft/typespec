...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class MultipleSpreadRecord : IJsonModel<MultipleSpreadRecord>
    {
        ...
        public static implicit operator BinaryContent(MultipleSpreadRecord multipleSpreadRecord)
        {
            if (multipleSpreadRecord == null)
            {
                return null;
            }
            return BinaryContent.Create(multipleSpreadRecord, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="MultipleSpreadRecord"/> from. </param>
        public static explicit operator MultipleSpreadRecord(ClientResult result)
        {
