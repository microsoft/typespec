...
namespace _Type.Property.Optional
{
    ...
    public partial class OptionalClient
    {
        ...
        {
            return Volatile.Read(ref _cachedPlainDate) ?? Interlocked.CompareExchange(ref _cachedPlainDate, new PlainDate(Pipeline, _endpoint), null) ?? _cachedPlainDate;
        }

        /// <summary> Initializes a new instance of PlainTime. </summary>
        public virtual PlainTime GetPlainTimeClient()
        {
            return Volatile.Read(ref _cachedPlainTime) ?? Interlocked.CompareExchange(ref _cachedPlainTime, new PlainTime(Pipeline, _endpoint), null) ?? _cachedPlainTime;
        }
        ...
        {
            return Volatile.Read(ref _cachedRequiredAndOptional) ?? Interlocked.CompareExchange(ref _cachedRequiredAndOptional, new RequiredAndOptional(Pipeline, _endpoint), null) ?? _cachedRequiredAndOptional;
        }
    }
}
