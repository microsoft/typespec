...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class IsString
    {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult<IsStringAdditionalProperties> Get(CancellationToken cancellationToken = default)
        {
            ClientResult result = Get(cancellationToken.ToRequestOptions());
            return ClientResult.FromValue((IsStringAdditionalProperties)result, result.GetRawResponse());
        }

        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<IsStringAdditionalProperties>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult Put(IsStringAdditionalProperties body, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> PutAsync(IsStringAdditionalProperties body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
