...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class DifferentSpreadModelArrayDerived : DifferentSpreadModelArrayRecord, IJsonModel<DifferentSpreadModelArrayDerived>
    {
        ...
        public static implicit operator BinaryContent(DifferentSpreadModelArrayDerived differentSpreadModelArrayDerived)
        {
            if (differentSpreadModelArrayDerived == null)
            {
                return null;
            }
            return BinaryContent.Create(differentSpreadModelArrayDerived, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="DifferentSpreadModelArrayDerived"/> from. </param>
        public static explicit operator DifferentSpreadModelArrayDerived(ClientResult result)
        {
