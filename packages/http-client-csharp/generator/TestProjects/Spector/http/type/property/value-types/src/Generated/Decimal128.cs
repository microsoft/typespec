...
namespace _Type.Property.ValueTypes
{
    ...
    public partial class Decimal128
    {
        ...
        internal Decimal128(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult<Decimal128Property> Get(CancellationToken cancellationToken = default)
        {
            ClientResult result = Get(cancellationToken.ToRequestOptions());
            return ClientResult.FromValue((Decimal128Property)result, result.GetRawResponse());
        }

        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<Decimal128Property>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult Put(Decimal128Property body, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> PutAsync(Decimal128Property body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
