...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadRecordForNonDiscriminatedUnion3 : IJsonModel<SpreadRecordForNonDiscriminatedUnion3>
    {
        ...
        public static implicit operator BinaryContent(SpreadRecordForNonDiscriminatedUnion3 spreadRecordForNonDiscriminatedUnion3)
        {
            if (spreadRecordForNonDiscriminatedUnion3 == null)
            {
                return null;
            }
            return BinaryContent.Create(spreadRecordForNonDiscriminatedUnion3, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="SpreadRecordForNonDiscriminatedUnion3"/> from. </param>
        public static explicit operator SpreadRecordForNonDiscriminatedUnion3(ClientResult result)
        {
