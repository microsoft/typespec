...
namespace _Type._Array
{
    public partial class NullableInt32Value
    {
        ...
        internal NullableInt32Value(ClientPipeline pipeline, ModelReaderWriterOptions modelReaderWriterOptions, Uri endpoint) => throw null;
        ...
        public virtual Task<ClientResult<IReadOnlyList<int?>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
