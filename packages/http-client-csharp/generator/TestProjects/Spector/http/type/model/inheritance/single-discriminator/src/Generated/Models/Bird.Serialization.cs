...
namespace _Type.Model.Inheritance.SingleDiscriminator
{
    ...
    public abstract partial class Bird : IJsonModel<Bird>
    {
        ...
        public static implicit operator BinaryContent(Bird bird)
        {
            if (bird == null)
            {
                return null;
            }
            return BinaryContent.Create(bird, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Bird"/> from. </param>
        public static explicit operator Bird(ClientResult result)
        {
