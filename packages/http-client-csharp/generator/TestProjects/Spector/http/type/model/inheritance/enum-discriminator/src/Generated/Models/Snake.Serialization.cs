...
namespace _Type.Model.Inheritance.EnumDiscriminator
{
    ...
    public abstract partial class Snake : IJsonModel<Snake>
    {
        ...
        public static implicit operator BinaryContent(Snake snake)
        {
            if (snake == null)
            {
                return null;
            }
            return BinaryContent.Create(snake, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Snake"/> from. </param>
        public static explicit operator Snake(ClientResult result)
        {
