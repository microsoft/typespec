...
namespace _Type.Model.Inheritance.NestedDiscriminator
{
    ...
    public static partial class TypeModelInheritanceNestedDiscriminatorModelFactory
    {
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="NestedDiscriminator.Shark"/> and <see cref="NestedDiscriminator.Salmon"/>.
        /// </summary>
        ...
        {
            return new Shark("shark", age, additionalBinaryDataProperties: null, default);
        }
        ...
        {
            return new SawShark("shark", age, additionalBinaryDataProperties: null, "saw");
        }
        ...
        {
            return new GoblinShark("shark", age, additionalBinaryDataProperties: null, "goblin");
        }
