...
namespace _Type.Model.Inheritance.NestedDiscriminator
{
    ...
    public abstract partial class Fish : IJsonModel<Fish>
    {
        ...
        public static implicit operator BinaryContent(Fish fish)
        {
            if (fish == null)
            {
                return null;
            }
            return BinaryContent.Create(fish, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Fish"/> from. </param>
        public static explicit operator Fish(ClientResult result)
        {
