...
namespace _Type.Model.Inheritance.NotDiscriminated
{
    ...
    public partial class Siamese : Cat, IJsonModel<Siamese>
    {
        ...
        /// <param name="siamese"> The <see cref="Siamese"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(Siamese siamese)
        {
            if (siamese == null)
            {
                return null;
            }
            return BinaryContent.Create(siamese, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Siamese"/> from. </param>
        public static explicit operator Siamese(ClientResult result)
        {
