...
namespace _Type.Union
{
    ...
    public partial class StringExtensibleNamed
    {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult<GetResponse2> Get(CancellationToken cancellationToken = default)
        {
            ClientResult result = Get(cancellationToken.ToRequestOptions());
            return ClientResult.FromValue((GetResponse2)result, result.GetRawResponse());
        }

        /// <summary> Get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<GetResponse2>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult Send(StringExtensibleNamedUnion prop, CancellationToken cancellationToken = default)
        {
            SendRequest2 spreadModel = new SendRequest2(prop, default);
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> SendAsync(StringExtensibleNamedUnion prop, CancellationToken cancellationToken = default)
        {
            SendRequest2 spreadModel = new SendRequest2(prop, default);
