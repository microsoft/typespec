...
namespace _Type.Union
{
    ...
    internal partial class SendRequest7 : IJsonModel<SendRequest7>
    {
        ...
        /// <param name="sendRequest7"> The <see cref="SendRequest7"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(SendRequest7 sendRequest7)
        {
            if (sendRequest7 == null)
            {
                return null;
            }
            return BinaryContent.Create(sendRequest7, ModelSerializationExtensions.WireOptions);
        }
    }
}
