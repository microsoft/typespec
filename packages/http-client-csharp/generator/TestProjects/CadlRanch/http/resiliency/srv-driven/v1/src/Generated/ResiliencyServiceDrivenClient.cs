...
namespace Resiliency.SrvDriven.V1
{
    ...
    public partial class ResiliencyServiceDrivenClient
    {
        ...
        {
            return FromNone(cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
        ...
        {
            return await FromNoneAsync(cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null).ConfigureAwait(false);
        }
        ...
        public virtual ClientResult FromOneRequired(string parameter, CancellationToken cancellationToken = default)
        {
            ...
            return FromOneRequired(parameter, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
        ...
        public virtual async Task<ClientResult> FromOneRequiredAsync(string parameter, CancellationToken cancellationToken = default)
        {
            ...
            return await FromOneRequiredAsync(parameter, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult FromOneOptional(string parameter = null, CancellationToken cancellationToken = default)
        {
            return FromOneOptional(parameter, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> FromOneOptionalAsync(string parameter = null, CancellationToken cancellationToken = default)
        {
            return await FromOneOptionalAsync(parameter, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null).ConfigureAwait(false);
        }
    }
}
