...
namespace SpecialHeaders.ConditionalRequest
{
    public partial class ConditionalRequestClient
    {
        ...
        public virtual Task<ClientResult> PostIfMatchAsync(string ifMatch = null) => throw null;
        ...
        public virtual Task<ClientResult> PostIfNoneMatchAsync(string ifNoneMatch = null) => throw null;
        ...
        public virtual Task<ClientResult> HeadIfModifiedSinceAsync(DateTimeOffset? ifModifiedSince = null) => throw null;
        ...
        public virtual Task<ClientResult> PostIfUnmodifiedSinceAsync(DateTimeOffset? ifUnmodifiedSince = null) => throw null;
    }
}
