...
namespace SpecialHeaders.ConditionalRequest
{
    ...
    public partial class ConditionalRequestClient
    {
        ...
        {
            return PostIfMatch(ifMatch, null);
        }

        /// <summary> Check when only If-Match in header is defined. </summary>
        /// <param name="ifMatch"> The request should only proceed if an entity matches this string. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> PostIfMatchAsync(string ifMatch = null)
        {
            return await PostIfMatchAsync(ifMatch, null).ConfigureAwait(false);
        }
        ...
        {
            return PostIfNoneMatch(ifNoneMatch, null);
        }

        /// <summary> Check when only If-None-Match in header is defined. </summary>
        /// <param name="ifNoneMatch"> The request should only proceed if no entity matches this string. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> PostIfNoneMatchAsync(string ifNoneMatch = null)
        {
            return await PostIfNoneMatchAsync(ifNoneMatch, null).ConfigureAwait(false);
        }
...
been modified since the specified time. </param>
        ...
        {
            return HeadIfModifiedSince(ifModifiedSince, null);
        }
...
been modified since the specified time. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> HeadIfModifiedSinceAsync(DateTimeOffset? ifModifiedSince = null)
        {
            return await HeadIfModifiedSinceAsync(ifModifiedSince, null).ConfigureAwait(false);
        }
...
not been modified since the specified time. </param>
        ...
        {
            return PostIfUnmodifiedSince(ifUnmodifiedSince, null);
        }
...
not been modified since the specified time. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult> PostIfUnmodifiedSinceAsync(DateTimeOffset? ifUnmodifiedSince = null)
        {
            return await PostIfUnmodifiedSinceAsync(ifUnmodifiedSince, null).ConfigureAwait(false);
        }
    }
}
