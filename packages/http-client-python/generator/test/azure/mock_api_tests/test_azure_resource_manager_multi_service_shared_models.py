...
def test_storage_accounts_get(client):
    """Test getting a storage account with shared metadata."""
    resource_group_name = "test-rg"
    account_name = "account1"

    result = client.storage_accounts.get(resource_group_name=resource_group_name, account_name=account_name)
...
def test_storage_accounts_create_or_update(client):
    ...
    poller = client.storage_accounts.begin_create_or_update(
        resource_group_name=resource_group_name,
