...
@pytest.mark.asyncio
async def test_extensions_resources_begin_create_or_update(client):
    result = await (
...
@pytest.mark.asyncio
async def test_extensions_resources_begin_create_or_update_by_subscription(client):
    result = await (
        await client.extensions_resources.begin_create_or_update(
...
@pytest.mark.asyncio
async def test_extensions_resources_begin_create_or_update_by_resource_group(client):
    result = await (
        await client.extensions_resources.begin_create_or_update(
...
@pytest.mark.asyncio
async def test_extensions_resources_begin_create_or_update_by_resource(client):
    result = await (
        await client.extensions_resources.begin_create_or_update(
...
@pytest.mark.asyncio
async def test_extensions_resources_update(client):
...
@pytest.mark.asyncio
async def test_extensions_resources_update_by_subscription(client):
    result = await client.extensions_resources.update(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000",
        extensions_resource_name="extension",
        properties=models.ExtensionsResource(properties=models.ExtensionsResourceProperties(description="valid2")),
...
@pytest.mark.asyncio
async def test_extensions_resources_update_by_resource_group(client):
    result = await client.extensions_resources.update(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg",
        extensions_resource_name="extension",
        properties=models.ExtensionsResource(properties=models.ExtensionsResourceProperties(description="valid2")),
...
@pytest.mark.asyncio
async def test_extensions_resources_update_by_resource(client):
    result = await client.extensions_resources.update(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/top",
        extensions_resource_name="extension",
        properties=models.ExtensionsResource(properties=models.ExtensionsResourceProperties(description="valid2")),
...
@pytest.mark.asyncio
async def test_extensions_resources_get(client):
    result = await client.extensions_resources.get(resource_uri="", extensions_resource_name="extension")
    assert result.id == "/providers/Azure.ResourceManager.Resources/extensionsResources/extension"
    assert result.name == "extension"
    assert result.type == "Azure.ResourceManager.Resources/extensionsResources"
    assert result.properties.description == "valid"
...
@pytest.mark.asyncio
async def test_extensions_resources_get_by_subscription(client):
    result = await client.extensions_resources.get(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000",
        extensions_resource_name="extension",
    )
    assert (
...
@pytest.mark.asyncio
async def test_extensions_resources_get_by_resource_group(client):
    result = await client.extensions_resources.get(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg",
        extensions_resource_name="extension",
    )
...
@pytest.mark.asyncio
async def test_extensions_resources_get_by_resource(client):
    result = await client.extensions_resources.get(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/top",
        extensions_resource_name="extension",
    )
...
@pytest.mark.asyncio
async def test_extensions_resources_list_by_scope(client):
...
@pytest.mark.asyncio
async def test_extensions_resources_list_by_subscription(client):
    response = client.extensions_resources.list_by_scope(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000",
    )
    result = [r async for r in response]
...
@pytest.mark.asyncio
async def test_extensions_resources_list_by_resource_group(client):
    response = client.extensions_resources.list_by_scope(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg",
    )
    result = [r async for r in response]
...
@pytest.mark.asyncio
async def test_extensions_resources_list_by_resource(client):
    response = client.extensions_resources.list_by_scope(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/top",
    )
    result = [r async for r in response]
...
@pytest.mark.asyncio
async def test_extensions_resources_delete(client):
    await client.extensions_resources.delete(resource_uri="", extensions_resource_name="extension")


@pytest.mark.asyncio
async def test_extensions_resources_delete_by_subscription(client):
    await client.extensions_resources.delete(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000",
        extensions_resource_name="extension",
    )
...
@pytest.mark.asyncio
async def test_extensions_resources_delete_by_resource_group(client):
    await client.extensions_resources.delete(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg",
        extensions_resource_name="extension",
    )
...
@pytest.mark.asyncio
async def test_extensions_resources_delete_by_resource(client):
    await client.extensions_resources.delete(
        resource_uri="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/top",
        extensions_resource_name="extension",
    )
