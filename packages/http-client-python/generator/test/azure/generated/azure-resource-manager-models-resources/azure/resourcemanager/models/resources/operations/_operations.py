...
def build_top_level_tracked_resources_get_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Models.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}"  # pylint: disable=line-too-long
...
def build_top_level_tracked_resources_list_by_resource_group_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Models.Resources/topLevelTrackedResources"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
    }
...
def build_top_level_tracked_resources_list_by_subscription_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.Models.Resources/topLevelTrackedResources"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_nested_proxy_resources_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Models.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/nestedProxyResources/{nextedProxyResourceName}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "topLevelTrackedResourceName": _SERIALIZER.url(
...
def build_nested_proxy_resources_list_by_top_level_tracked_resource_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Models.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/nestedProxyResources"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "topLevelTrackedResourceName": _SERIALIZER.url(
...
class TopLevelTrackedResourcesOperations:
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.resourcemanager.models.resources.models.TopLevelTrackedResource
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.resourcemanager.models.resources.models.TopLevelTrackedResource or JSON
         or IO[bytes]
        :return: An instance of LROPoller that returns TopLevelTrackedResource. The
         TopLevelTrackedResource is compatible with MutableMapping
        :rtype:
...
class NestedProxyResourcesOperations:
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :type nexted_proxy_resource_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.resourcemanager.models.resources.models.NestedProxyResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.resourcemanager.models.resources.models.NestedProxyResource or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns NestedProxyResource. The NestedProxyResource is
         compatible with MutableMapping
        :rtype:
