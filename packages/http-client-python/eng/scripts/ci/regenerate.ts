...
interface BuildTaskGroupsOptions {
...
function defaultPackageName(spec: string, ctx: RegenerateContext): string {
...
async function prepareBaselineOfGeneratedCode(generatedFolder: string): Promise<void> {
