...
class TestAdditionalPropertiesSpreadDifferentModelArrayOperationsAsync(AdditionalPropertiesClientTestBaseAsync):
    ...
    async def test_get(self, additionalproperties_endpoint):
        ...
        response = await client.spread_different_model_array.get()
