 ...
 */
export function durationTotalMilliseconds(duration: Temporal.Duration): number {
  if (
    duration.years !== 0 ||
    duration.months !== 0 ||
    duration.weeks !== 0 ||
 ...
 * @returns the total number of milliseconds in the duration
 */
export function durationTotalMillisecondsBigInt(duration: Temporal.Duration): bigint {
  if (
    duration.years !== 0 ||
    duration.months !== 0 ||
    duration.weeks !== 0 ||
