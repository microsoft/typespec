...
namespace Client.Structure.Service.rename.operation
{
    ...
    public partial class RenamedOperationClient
    {
        ...
        /// <include file="Docs/RenamedOperationClient.xml" path="doc/members/member[@name='RenamedOneAsync(RequestContext)']/*" />
        public virtual async Task<Response> RenamedOneAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("RenamedOperationClient.RenamedOne");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RenamedOperationClient.xml" path="doc/members/member[@name='RenamedOne(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RenamedOperationClient.xml" path="doc/members/member[@name='RenamedThreeAsync(RequestContext)']/*" />
        public virtual async Task<Response> RenamedThreeAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("RenamedOperationClient.RenamedThree");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RenamedOperationClient.xml" path="doc/members/member[@name='RenamedThree(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RenamedOperationClient.xml" path="doc/members/member[@name='RenamedFiveAsync(RequestContext)']/*" />
        public virtual async Task<Response> RenamedFiveAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("RenamedOperationClient.RenamedFive");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RenamedOperationClient.xml" path="doc/members/member[@name='RenamedFive(RequestContext)']/*" />
        ...
        {
            return Volatile.Read(ref _cachedGroup) ?? Interlocked.CompareExchange(ref _cachedGroup, new Group(ClientDiagnostics, _pipeline, _endpoint, _client), null) ?? _cachedGroup;
        }
