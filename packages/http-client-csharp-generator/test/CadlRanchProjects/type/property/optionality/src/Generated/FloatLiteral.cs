...
namespace _Type.Property.Optionality
{
    ...
    public partial class FloatLiteral
    {
        ...
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetAllAsync(CancellationToken)']/*" />
        public virtual async Task<Response<FloatLiteralProperty>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetAllAsync(context).ConfigureAwait(false);
            return Response.FromValue(FloatLiteralProperty.FromResponse(response), response);
        }

        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetAll(CancellationToken)']/*" />
        public virtual Response<FloatLiteralProperty> GetAll(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetAllAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetAllAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("FloatLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetAll(RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetDefaultAsync(CancellationToken)']/*" />
        public virtual async Task<Response<FloatLiteralProperty>> GetDefaultAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <summary> Get models that will return the default object. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetDefault(CancellationToken)']/*" />
        public virtual Response<FloatLiteralProperty> GetDefault(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetDefaultAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetDefaultAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("FloatLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='GetDefault(RequestContext)']/*" />
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAllAsync(FloatLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='PutAllAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAllAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("FloatLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAll(FloatLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='PutAll(RequestContent,RequestContext)']/*" />
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutDefaultAsync(FloatLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='PutDefaultAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutDefaultAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("FloatLiteral.PutDefault");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutDefault(FloatLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatLiteral.xml" path="doc/members/member[@name='PutDefault(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetAllRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/optional/float/literal/all", false);
            request.Uri = uri;
        ...
        internal HttpMessage CreateGetDefaultRequest(RequestContext context)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/optional/float/literal/default", false);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        }
