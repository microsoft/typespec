...
namespace _Type.Property.ValueTypes
{
    ...
    public partial class CollectionsString
    {
        ...
        /// <include file="Docs/CollectionsString.xml" path="doc/members/member[@name='GetCollectionsStringAsync(CancellationToken)']/*" />
        ...
        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/CollectionsString.xml" path="doc/members/member[@name='GetCollectionsString(CancellationToken)']/*" />
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetCollectionsStringAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response> GetCollectionsStringAsync(RequestContext context)
        {
            ...
            try
            {
                using HttpMessage message = CreateGetCollectionsStringRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetCollectionsString(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/CollectionsString.xml" path="doc/members/member[@name='PutAsync(CollectionsStringProperty,CancellationToken)']/*" />
        public virtual async Task<Response> PutAsync(CollectionsStringProperty body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <include file="Docs/CollectionsString.xml" path="doc/members/member[@name='Put(CollectionsStringProperty,CancellationToken)']/*" />
        public virtual Response Put(CollectionsStringProperty body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(CollectionsStringProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CollectionsString.Put");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(CollectionsStringProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal HttpMessage CreateGetCollectionsStringRequest(RequestContext context)
        {
