...
namespace _Type.Property.Nullable
{
    ...
    public partial class Duration
    {
        ...
        /// <include file="Docs/Duration.xml" path="doc/members/member[@name='GetNonNullAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetNonNullAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("Duration.GetNonNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Duration.xml" path="doc/members/member[@name='GetNonNull(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Duration.xml" path="doc/members/member[@name='GetNullAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetNullAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("Duration.GetNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Duration.xml" path="doc/members/member[@name='GetNull(RequestContext)']/*" />
