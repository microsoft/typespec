...
namespace _Type.Union
{
    ...
    public partial class StringExtensibleNamed
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetStringExtensibleNamedAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/StringExtensibleNamed.xml" path="doc/members/member[@name='GetStringExtensibleNamedAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetStringExtensibleNamedAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("StringExtensibleNamed.GetStringExtensibleNamed");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetStringExtensibleNamedRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetStringExtensibleNamed(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/StringExtensibleNamed.xml" path="doc/members/member[@name='GetStringExtensibleNamed(RequestContext)']/*" />
        public virtual Response GetStringExtensibleNamed(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("StringExtensibleNamed.GetStringExtensibleNamed");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetStringExtensibleNamedRequest(RequestContext context)
        {
