...
namespace SpecialWords
{
    public partial class Elif : IUtf8JsonSerializable, IJsonModel<Elif>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<Elif>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Elif)} does not support '{format}' format.");
            }
