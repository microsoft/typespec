...
namespace SpecialWords
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Finally>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Finally>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Finally)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Finally>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Finally)} does not support '{options.Format}' format.");
            }
        }
