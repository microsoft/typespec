...
namespace body_complex.Models
{
    ...
    public partial class Cookiecuttershark : Shark
    {
        ...
        /// <param name="birthday"></param>
        internal Cookiecuttershark(string fishtype, string species, float length, IList<Fish> siblings, IDictionary<string, BinaryData> serializedAdditionalRawData, int? age, DateTimeOffset birthday) : base(fishtype, species, length, siblings, serializedAdditionalRawData, age, birthday)
        {
