...
namespace lro
{
    internal partial class LROsDeleteAsyncRetryFailedHeaders
    {
        ...
        /// <summary> Location to poll for result status: will be set to /lro/deleteasync/retry/failed/operationResults/200. </summary>
