...
namespace lro
{
    internal partial class LROsDeleteAsyncRetrycanceledHeaders
    {
        ...
        /// <summary> Location to poll for result status: will be set to /lro/deleteasync/retry/canceled/operationResults/200. </summary>
