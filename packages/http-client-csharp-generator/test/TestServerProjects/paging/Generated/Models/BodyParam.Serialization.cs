...
namespace paging.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BodyParam>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        string IPersistableModel<BodyParam>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
