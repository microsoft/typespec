...
namespace MgmtSafeFlatten.Mocking
{
    ...
    public partial class MockableMgmtSafeFlattenResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtSafeFlattenResourceGroupResource"/> class for mocking. </summary>
        protected MockableMgmtSafeFlattenResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMgmtSafeFlattenResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMgmtSafeFlattenResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
