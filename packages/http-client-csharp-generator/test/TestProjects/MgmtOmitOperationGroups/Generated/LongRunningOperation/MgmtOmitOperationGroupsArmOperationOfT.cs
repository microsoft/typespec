...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtOmitOperationGroupsArmOperation(Response<T> response)
        {
        ...
        internal MgmtOmitOperationGroupsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "MgmtOmitOperationGroupsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
