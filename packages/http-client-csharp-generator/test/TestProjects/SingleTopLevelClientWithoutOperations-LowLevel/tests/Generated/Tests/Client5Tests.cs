...
{
    public partial class Client5Tests : SingleTopLevelClientWithoutOperations_LowLevelTestBase
    {
        ...
        public async Task Operation_ShortVersion()
        {
            ...
            Client5 client = CreateTopLevelClientWithoutOperationClient(endpoint, credential).GetClient5Client();
