...
namespace SingleTopLevelClientWithoutOperations_LowLevel
{
    ...
    public partial class Client7
    {
        ...
        /// <summary> Initializes a new instance of Client7 for mocking. </summary>
        protected Client7()
        {
        }
        ...
        /// <include file="Docs/Client7.xml" path="doc/members/member[@name='OperationAsync(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Client7.xml" path="doc/members/member[@name='Operation(RequestContext)']/*" />
