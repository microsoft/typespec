...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySetChildData : TrackedResourceData
    {
        ...
        internal AvailabilitySetChildData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, resourceType, systemData, tags, location)
        {
            Bar = bar;
        }
