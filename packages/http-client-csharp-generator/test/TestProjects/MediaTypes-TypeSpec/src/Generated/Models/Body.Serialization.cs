...
namespace MultipleMediaTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Body>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Body>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Body)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Body>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Body)} does not support '{options.Format}' format.");
            }
        }
