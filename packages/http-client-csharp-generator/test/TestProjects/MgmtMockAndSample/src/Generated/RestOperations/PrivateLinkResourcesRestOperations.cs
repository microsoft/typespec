...
namespace MgmtMockAndSample
{
    internal partial class PrivateLinkResourcesRestOperations
    {
        ...
        public async Task<Response<MgmtMockAndSamplePrivateLinkResourceListResult>> ListByVaultAsync(string subscriptionId, string resourceGroupName, string vaultName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        MgmtMockAndSamplePrivateLinkResourceListResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = MgmtMockAndSamplePrivateLinkResourceListResult.DeserializeMgmtMockAndSamplePrivateLinkResourceListResult(document.RootElement);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="vaultName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="vaultName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<MgmtMockAndSamplePrivateLinkResourceListResult> ListByVault(string subscriptionId, string resourceGroupName, string vaultName, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
