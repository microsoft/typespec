    ...
    public partial class FakeResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FakeResource>> UpdateAsync(WaitUntil waitUntil, FakePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtLROArmOperation<FakeResource>(new FakeOperationSource(Client), _fakeClientDiagnostics, Pipeline, _fakeRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location, apiVersionOverrideValue: "2021-06-01");
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fake/fakes/{fakeName}/doSomethingLRO</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Fakes_DoSomethingLRO</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2020-06-01</description>
        ...
        {
            using var scope = _fakeClientDiagnostics.CreateScope("FakeResource.DoSomethingLRO");
            scope.Start();
            try
            {
