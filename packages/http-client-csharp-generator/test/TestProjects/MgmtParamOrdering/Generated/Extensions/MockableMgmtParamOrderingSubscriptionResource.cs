...
namespace MgmtParamOrdering.Mocking
{
    ...
    public partial class MockableMgmtParamOrderingSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtParamOrderingSubscriptionResource"/> class for mocking. </summary>
        protected MockableMgmtParamOrderingSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMgmtParamOrderingSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMgmtParamOrderingSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
