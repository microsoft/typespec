...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithNonResChData : TrackedResourceData
    {
        ...
        public TenantParentWithNonResChData(AzureLocation location) : base(location)
        {
        }
        ...
        internal TenantParentWithNonResChData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, resourceType, systemData, tags, location)
        {
            Bar = bar;
        }
