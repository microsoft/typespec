...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithNonResChResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/providers/Microsoft.Fake/fakes/{fakeName}/fakeParentWithNonResChes/{fakeParentWithNonResChName}/nonResourceChild</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>FakeParentWithNonResChes_ListNonResourceChild</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2020-06-01</description>
        ...
        public virtual AsyncPageable<NonResourceChild> GetNonResourceChildAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, NonResourceChild.DeserializeNonResourceChild, _fakeParentWithNonResChClientDiagnostics, Pipeline, "FakeParentWithNonResChResource.GetNonResourceChild", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _fakeParentWithNonResChRestClient.CreateListNonResourceChildRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, NonResourceChild.DeserializeNonResourceChild, _fakeParentWithNonResChClientDiagnostics, Pipeline, "FakeParentWithNonResChResource.GetNonResourceChild", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<FakeParentWithNonResChResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new FakeParentWithNonResChResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
