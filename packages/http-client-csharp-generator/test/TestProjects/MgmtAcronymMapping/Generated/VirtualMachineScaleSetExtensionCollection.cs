...
namespace MgmtAcronymMapping
{
    ...
    public partial class VirtualMachineScaleSetExtensionCollection : ArmCollection, IEnumerable<VirtualMachineScaleSetExtensionResource>, IAsyncEnumerable<VirtualMachineScaleSetExtensionResource>
    {
        ...
        {
            _virtualMachineScaleSetExtensionClientDiagnostics = new ClientDiagnostics("MgmtAcronymMapping", VirtualMachineScaleSetExtensionResource.ResourceType.Namespace, Diagnostics);
