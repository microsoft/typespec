...
{
    /// <summary>
    /// A Class representing a PageSizeInt64Model along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PageSizeInt64ModelResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetPageSizeInt64ModelResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetPageSizeInt64Model method.
    /// </summary>
    public partial class PageSizeInt64ModelResource : ArmResource
    {
        ...
        {
            _pageSizeInt64ModelClientDiagnostics = new ClientDiagnostics("MgmtPagination", ResourceType.Namespace, Diagnostics);
        ...
        {
            using var scope = _pageSizeInt64ModelClientDiagnostics.CreateScope("PageSizeInt64ModelResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<PageSizeInt64ModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeInt64ModelData data, CancellationToken cancellationToken = default)
        {
            if (data == null)
            {
            ...
            using var scope = _pageSizeInt64ModelClientDiagnostics.CreateScope("PageSizeInt64ModelResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<PageSizeInt64ModelResource> Update(WaitUntil waitUntil, PageSizeInt64ModelData data, CancellationToken cancellationToken = default)
        {
            if (data == null)
            {
                throw new ArgumentNullException(nameof(data));
