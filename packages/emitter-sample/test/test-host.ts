...
import { SampleEmitterTestLibrary } from "../src/testing/index.js";
...
export async function createSampleEmitterTestRunner() {
...
export async function emitWithDiagnostics(
  ...
  const emitterOutputDir = "./tsp-output/emitter-sample";
