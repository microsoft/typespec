  ...
  describe("@useAuth", () => {
    ...
    it("can specify multiple auth options", async () => {
      ...
      deepStrictEqual(getAuthentication(runner.program, Foo), {
        options: [
          {
            schemes: [{ id: "BasicAuth", type: "http", scheme: "basic", description: docs.basic }],
          },
          {
            schemes: [
              { id: "BearerAuth", type: "http", scheme: "bearer", description: docs.bearer },
            ],
          },
        ],
      });
    ...
    it("can specify multiple auth schemes to be used together", async () => {
      ...
      deepStrictEqual(getAuthentication(runner.program, Foo), {
        options: [
          {
            schemes: [
              { id: "BasicAuth", type: "http", scheme: "basic", description: docs.basic },
              { id: "BearerAuth", type: "http", scheme: "bearer", description: docs.bearer },
            ],
          },
        ],
