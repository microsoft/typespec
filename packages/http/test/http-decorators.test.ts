    ...
    it("emit diagnostics when header name is not a string or of type HeaderOptions", async () => {
      ...
      expectDiagnostics(diagnostics, [
        ...
        },
        {
          code: "invalid-argument",
          message:
            "Argument '(anonymous model)' is not assignable to parameter of type 'string | Http.HeaderOptions'",
        },
        {
          code: "invalid-argument",
          message:
    ...
    it("emit diagnostics when query name is not a string or of type QueryOptions", async () => {
      ...
      expectDiagnostics(diagnostics, [
        ...
        },
        {
          code: "invalid-argument",
          message:
            "Argument '(anonymous model)' is not assignable to parameter of type 'string | Http.QueryOptions'",
        },
        {
          code: "invalid-argument",
          message:
