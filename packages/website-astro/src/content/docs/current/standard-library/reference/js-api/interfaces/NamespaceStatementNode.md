...
| `readonly` | `kind` | `NamespaceStatement` | - | [`BaseNode`](BaseNode.md).`kind` |
...
| `readonly` | `statements?` | [`NamespaceStatementNode`](NamespaceStatementNode.md) \| readonly [`Statement`](../type-aliases/Statement.md)[] | - | - |
