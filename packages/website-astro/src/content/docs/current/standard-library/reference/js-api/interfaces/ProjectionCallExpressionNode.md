...
| :------ | :------ | :------ | :------ | :------ |
| `readonly` | `arguments` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md)[] | - | - |
...
| `readonly` | `kind` | `ProjectionCallExpression` | - | [`BaseNode`](BaseNode.md).`kind` |
...
| `readonly` | `target` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - |
