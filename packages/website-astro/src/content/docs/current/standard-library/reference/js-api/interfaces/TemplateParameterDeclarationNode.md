...
| `readonly` | `kind` | `TemplateParameterDeclaration` | - | [`BaseNode`](BaseNode.md).`kind` |
| `readonly` | `parent?` | [`TemplateableNode`](../type-aliases/TemplateableNode.md) | - | [`BaseNode`](BaseNode.md).`parent` |
