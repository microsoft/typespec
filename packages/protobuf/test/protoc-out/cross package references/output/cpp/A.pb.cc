...
static ::_pb::Metadata file_level_metadata_A_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_A_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_A_2eproto = nullptr;
const ::uint32_t TableStruct_A_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::A::Output, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::A::Output, _impl_.testoutputfield_),
    PROTOBUF_FIELD_OFFSET(::A::Output, _impl_.secondfield_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::A::Output)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::A::_Output_default_instance_._instance,
};
const char descriptor_table_protodef_A_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\007A.proto\022\001A\"6\n\006Output\022\027\n\017testOutputFiel"
    "d\030\001 \001(\005\022\023\n\013secondField\030\002 \001(\tb\006proto3"
};
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_A_2eproto(&descriptor_table_A_2eproto);
namespace A {
// ===================================================================
...
Output::Output(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:A.Output)
}
Output::Output(const Output& from)
  ...
  // @@protoc_insertion_point(copy_constructor:A.Output)
}
...
Output::~Output() {
  // @@protoc_insertion_point(destructor:A.Output)
...
void Output::Clear() {
// @@protoc_insertion_point(message_clear_start:A.Output)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "A.Output.secondField"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* Output::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:A.Output)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:A.Output)
  return target;
}

::size_t Output::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:A.Output)
  ::size_t total_size = 0;
...
void Output::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:A.Output)
...
// @@protoc_insertion_point(class_specific_copy_from_start:A.Output)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::A::Output*
Arena::CreateMaybeMessage< ::A::Output >(Arena* arena) {
  return Arena::CreateMessageInternal< ::A::Output >(arena);
}
