...
PROTOBUF_NAMESPACE_OPEN
template <>
::FooResponse* Arena::CreateMaybeMessage<::FooResponse>(Arena*);
template <>
...
class FooResponse final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:FooResponse) */ {
 public:
