...
inline std::string* Input::release_testinputfield() {
  // @@protoc_insertion_point(field_release:com.azure.Test.Input.testInputField)
...
inline void Input::set_allocated_testinputfield(std::string* testinputfield) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.azure.Test.Input.testInputField)
}
