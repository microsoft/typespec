...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `base` | `readonly` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - | - |
...
| `kind` | `readonly` | `ProjectionMemberExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
