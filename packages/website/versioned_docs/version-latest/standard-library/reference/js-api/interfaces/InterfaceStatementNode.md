...
| `extends` | `readonly` | readonly [`TypeReferenceNode`](TypeReferenceNode.md)[] | - | - | - |
...
| `kind` | `readonly` | `InterfaceStatement` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `operations` | `readonly` | readonly [`OperationStatementNode`](OperationStatementNode.md)[] | - | - | - |
