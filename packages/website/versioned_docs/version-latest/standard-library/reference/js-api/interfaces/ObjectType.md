...
| `kind` | `"Object"` | - | [`BaseType`](BaseType.md).`kind` | [`BaseType`](BaseType.md).`kind` |
| `node?` | [`Node`](../type-aliases/Node.md) | - | [`BaseType`](BaseType.md).`node` | [`BaseType`](BaseType.md).`node` |
...
| `properties` | `Record`<`string`, [`Type`](../type-aliases/Type.md)\> | - | - | - |
