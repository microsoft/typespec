...
| `kind` | `readonly` | `TupleExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `values` | `readonly` | readonly [`Expression`](../type-aliases/Expression.md)[] | - | - | - |
