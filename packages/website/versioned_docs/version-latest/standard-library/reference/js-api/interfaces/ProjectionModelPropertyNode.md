...
| `default?` | `readonly` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - | - |
...
| `kind` | `readonly` | `ProjectionModelProperty` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `value` | `readonly` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - | - |
