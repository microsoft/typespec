...
| `kind` | `readonly` | `ProjectionBlockExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `statements` | `readonly` | [`ProjectionExpressionStatementNode`](ProjectionExpressionStatementNode.md)[] | - | - | - |
