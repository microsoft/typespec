...
| `readonly` | `head` | [`StringTemplateHeadNode`](StringTemplateHeadNode.md) | - | - |
| `readonly` | `kind` | `StringTemplateExpression` | - | [`BaseNode.kind`](BaseNode.md) |
...
| `readonly` | `spans` | readonly [`StringTemplateSpanNode`](StringTemplateSpanNode.md)[] | - | - |
