---
jsApi: true
title: "[I] StringTemplateExpressionNode"
...
| `head` | `readonly` | [`StringTemplateHeadNode`](StringTemplateHeadNode.md) | - | - | - |
| `kind` | `readonly` | `StringTemplateExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `spans` | `readonly` | readonly [`StringTemplateSpanNode`](StringTemplateSpanNode.md)[] | - | - | - |
