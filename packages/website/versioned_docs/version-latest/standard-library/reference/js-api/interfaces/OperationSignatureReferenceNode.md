...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `baseOperation` | `readonly` | [`TypeReferenceNode`](TypeReferenceNode.md) | - | - | - |
...
| `kind` | `readonly` | `OperationSignatureReference` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
