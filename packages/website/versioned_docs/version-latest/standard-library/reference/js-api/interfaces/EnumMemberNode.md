...
| `readonly` | `kind` | `EnumMember` | - | [`BaseNode`](BaseNode.md).`kind` |
| `readonly` | `parent?` | [`EnumStatementNode`](EnumStatementNode.md) | - | [`BaseNode`](BaseNode.md).`parent` |
...
| `readonly` | `value?` | [`StringLiteralNode`](StringLiteralNode.md) \| [`NumericLiteralNode`](NumericLiteralNode.md) | - | - |
