---
jsApi: true
title: "[I] ObjectLiteralSpreadPropertyNode"
...
| `kind` | `readonly` | `ObjectLiteralSpreadProperty` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
| `parent?` | `readonly` | [`ObjectLiteralNode`](ObjectLiteralNode.md) | - | [`BaseNode`](BaseNode.md).`parent` | [`BaseNode`](BaseNode.md).`parent` |
