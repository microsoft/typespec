---
jsApi: true
title: "[I] ProjectionModelExpressionNode"
...
| `kind` | `readonly` | `ProjectionModelExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `properties` | `readonly` | ([`ProjectionModelPropertyNode`](ProjectionModelPropertyNode.md) \| [`ProjectionModelSpreadPropertyNode`](ProjectionModelSpreadPropertyNode.md))[] | - | - | - |
