---
jsApi: true
title: "[I] ProjectionCallExpressionNode"
...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `arguments` | `readonly` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md)[] | - | - | - |
| `callKind` | `readonly` | `"template"` \| `"method"` | - | - | - |
...
| `kind` | `readonly` | `ProjectionCallExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `target` | `readonly` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - | - |
