...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `arguments` | `readonly` | readonly [`TemplateArgumentNode`](TemplateArgumentNode.md)[] | - | - | - |
...
| `kind` | `readonly` | `TypeReference` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
