...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `body` | `readonly` | [`ProjectionBlockExpressionNode`](ProjectionBlockExpressionNode.md) | - | - | - |
...
| `kind` | `readonly` | `ProjectionLambdaExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
| `locals?` | `readonly` | `SymbolTable` | - | - | - |
| `parameters` | `readonly` | readonly [`ProjectionLambdaParameterDeclarationNode`](ProjectionLambdaParameterDeclarationNode.md)[] | - | - | - |
