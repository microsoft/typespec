...
| `kind` | `readonly` | `ObjectLiteral` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `properties` | `readonly` | ([`ObjectLiteralPropertyNode`](ObjectLiteralPropertyNode.md) \| [`ObjectLiteralSpreadPropertyNode`](ObjectLiteralSpreadPropertyNode.md))[] | - | - | - |
