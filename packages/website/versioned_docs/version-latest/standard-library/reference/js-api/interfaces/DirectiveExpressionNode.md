...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `arguments` | `readonly` | readonly [`DirectiveArgument`](../type-aliases/DirectiveArgument.md)[] | - | - | - |
...
| `kind` | `readonly` | `DirectiveExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `target` | `readonly` | [`IdentifierNode`](IdentifierNode.md) | - | - | - |
