...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `alternate?` | `readonly` | [`ProjectionIfExpressionNode`](ProjectionIfExpressionNode.md) \| [`ProjectionBlockExpressionNode`](ProjectionBlockExpressionNode.md) | - | - | - |
| `consequent` | `readonly` | [`ProjectionBlockExpressionNode`](ProjectionBlockExpressionNode.md) | - | - | - |
...
| `kind` | `readonly` | `ProjectionIfExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
...
| `test` | `readonly` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - | - |
