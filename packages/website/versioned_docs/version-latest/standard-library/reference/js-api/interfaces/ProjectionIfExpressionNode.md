...
| :------ | :------ | :------ | :------ | :------ |
| `readonly` | `alternate?` | [`ProjectionIfExpressionNode`](ProjectionIfExpressionNode.md) \| [`ProjectionBlockExpressionNode`](ProjectionBlockExpressionNode.md) | - | - |
...
| `readonly` | `kind` | `ProjectionIfExpression` | - | [`BaseNode`](BaseNode.md).`kind` |
...
| `readonly` | `test` | [`ProjectionExpression`](../type-aliases/ProjectionExpression.md) | - | - |
