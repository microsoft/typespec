...
| `kind` | `readonly` | `ScalarConstructor` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
| `parameters` | `readonly` | [`FunctionParameterNode`](FunctionParameterNode.md)[] | - | - | - |
| `parent?` | `readonly` | [`ScalarStatementNode`](ScalarStatementNode.md) | - | [`BaseNode`](BaseNode.md).`parent` | [`BaseNode`](BaseNode.md).`parent` |
