...
| `readonly` | `extends?` | [`Expression`](../type-aliases/Expression.md) | - | - |
...
| `readonly` | `is?` | [`Expression`](../type-aliases/Expression.md) | - | - |
| `readonly` | `kind` | `ModelStatement` | - | [`BaseNode.kind`](BaseNode.md) |
