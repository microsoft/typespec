...
| `kind` | `readonly` | `FunctionParameter` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
| `optional` | `readonly` | `boolean` | Parameter defined with `?` | - | - |
...
| `rest` | `readonly` | `boolean` | Parameter defined with `...` notation. | - | - |
...
| `type?` | `readonly` | [`Expression`](../type-aliases/Expression.md) | - | - | - |
