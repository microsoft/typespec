...
| `kind` | `public` | `"TemplateParameter"` | - | [`BaseType`](BaseType.md).`kind` | - |
| `node` | `public` | [`TemplateParameterDeclarationNode`](TemplateParameterDeclarationNode.md) | - | [`BaseType`](BaseType.md).`node` | - |
