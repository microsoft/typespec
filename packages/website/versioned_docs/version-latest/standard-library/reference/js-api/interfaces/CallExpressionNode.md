...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `arguments` | `readonly` | [`Expression`](../type-aliases/Expression.md)[] | - | - | - |
...
| `kind` | `readonly` | `CallExpression` | - | [`BaseNode`](BaseNode.md).`kind` | [`BaseNode`](BaseNode.md).`kind` |
