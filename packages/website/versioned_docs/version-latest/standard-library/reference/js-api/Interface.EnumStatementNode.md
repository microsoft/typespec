...
| `readonly` `kind` | [`EnumStatement`](Enumeration.SyntaxKind.md#enumstatement) | - |
| `readonly` `members` | *readonly* ([`EnumMemberNode`](Interface.EnumMemberNode.md) \| [`EnumSpreadMemberNode`](Interface.EnumSpreadMemberNode.md))[] | - |
