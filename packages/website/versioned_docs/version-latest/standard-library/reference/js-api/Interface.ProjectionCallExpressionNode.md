...
| :------ | :------ | :------ |
| `readonly` `arguments` | [`ProjectionExpression`](Type.ProjectionExpression.md)[] | - |
...
| `readonly` `kind` | [`ProjectionCallExpression`](Enumeration.SyntaxKind.md#projectioncallexpression) | - |
...
| `readonly` `target` | [`ProjectionExpression`](Type.ProjectionExpression.md) | - |
