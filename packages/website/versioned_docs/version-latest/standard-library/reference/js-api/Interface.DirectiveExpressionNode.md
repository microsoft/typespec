...
| :------ | :------ | :------ |
| `readonly` `arguments` | *readonly* [`DirectiveArgument`](Type.DirectiveArgument.md)[] | - |
...
| `readonly` `kind` | [`DirectiveExpression`](Enumeration.SyntaxKind.md#directiveexpression) | - |
...
| `readonly` `target` | [`IdentifierNode`](Interface.IdentifierNode.md) | - |
