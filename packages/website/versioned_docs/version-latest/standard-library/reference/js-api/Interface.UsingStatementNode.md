...
| `readonly` `kind` | [`UsingStatement`](Enumeration.SyntaxKind.md#usingstatement) | - |
| `readonly` `name` | [`MemberExpressionNode`](Interface.MemberExpressionNode.md) \| [`IdentifierNode`](Interface.IdentifierNode.md) | - |
