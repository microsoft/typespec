---
jsApi: true
title: "[I] OperationSignatureReferenceNode"
...
| :------ | :------ | :------ |
| `readonly` `baseOperation` | [`TypeReferenceNode`](Interface.TypeReferenceNode.md) | - |
...
| `readonly` `kind` | [`OperationSignatureReference`](Enumeration.SyntaxKind.md#operationsignaturereference) | - |
