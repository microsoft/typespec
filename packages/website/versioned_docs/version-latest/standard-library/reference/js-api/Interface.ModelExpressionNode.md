...
| `readonly` `kind` | [`ModelExpression`](Enumeration.SyntaxKind.md#modelexpression) | - |
...
| `readonly` `properties` | ([`ModelPropertyNode`](Interface.ModelPropertyNode.md) \| [`ModelSpreadPropertyNode`](Interface.ModelSpreadPropertyNode.md))[] | - |
