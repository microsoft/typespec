...
| `readonly` `kind` | [`NamespaceStatement`](Enumeration.SyntaxKind.md#namespacestatement) | - |
| `locals`? | `SymbolTable` | - |
...
| `statements`? | [`NamespaceStatementNode`](Interface.NamespaceStatementNode.md) \| *readonly* [`Statement`](Type.Statement.md)[] | - |
