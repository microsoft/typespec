---
jsApi: true
title: "[I] ProjectionBlockExpressionNode"
...
| `readonly` `kind` | [`ProjectionBlockExpression`](Enumeration.SyntaxKind.md#projectionblockexpression) | - |
...
| `readonly` `statements` | [`ProjectionExpressionStatementNode`](Interface.ProjectionExpressionStatementNode.md)[] | - |
