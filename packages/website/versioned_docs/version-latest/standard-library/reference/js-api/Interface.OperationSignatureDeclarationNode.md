---
jsApi: true
title: "[I] OperationSignatureDeclarationNode"
...
| `readonly` `kind` | [`OperationSignatureDeclaration`](Enumeration.SyntaxKind.md#operationsignaturedeclaration) | - |
| `readonly` `parameters` | [`ModelExpressionNode`](Interface.ModelExpressionNode.md) | - |
...
| `readonly` `returnType` | [`Expression`](Type.Expression.md) | - |
