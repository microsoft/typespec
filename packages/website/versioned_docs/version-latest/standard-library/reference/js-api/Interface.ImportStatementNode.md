...
| `readonly` `kind` | [`ImportStatement`](Enumeration.SyntaxKind.md#importstatement) | - |
| `parent`? | [`TypeSpecScriptNode`](Interface.TypeSpecScriptNode.md) | - |
| `readonly` `path` | [`StringLiteralNode`](Interface.StringLiteralNode.md) | - |
