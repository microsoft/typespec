...
| `readonly` `expr` | [`ProjectionExpression`](Type.ProjectionExpression.md) | - |
| `readonly` `flags` | [`NodeFlags`](Enumeration.NodeFlags.md) | - |
| `readonly` `kind` | [`ProjectionExpressionStatement`](Enumeration.SyntaxKind.md#projectionexpressionstatement) | - |
