...
| `kind` | `"Projection"` | - |
| `node` | `undefined` | - |
| `nodeByKind` | `Map`< `string`, [`ProjectionStatementNode`](Interface.ProjectionStatementNode.md) \> | - |
| `nodeByType` | `Map`< [`Type`](Type.Type.md), [`ProjectionStatementNode`](Interface.ProjectionStatementNode.md) \> | - |
