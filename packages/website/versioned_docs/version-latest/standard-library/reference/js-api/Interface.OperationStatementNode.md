...
| `readonly` `kind` | [`OperationStatement`](Enumeration.SyntaxKind.md#operationstatement) | - |
| `locals`? | `SymbolTable` | - |
| `parent`? | [`TypeSpecScriptNode`](Interface.TypeSpecScriptNode.md) \| [`NamespaceStatementNode`](Interface.NamespaceStatementNode.md) \| [`InterfaceStatementNode`](Interface.InterfaceStatementNode.md) | - |
...
| `readonly` `signature` | [`OperationSignature`](Type.OperationSignature.md) | - |
