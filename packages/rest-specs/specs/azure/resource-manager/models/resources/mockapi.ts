...
Scenarios.Azure_ResourceManager_Models_Resources_TopLevelTracked_Resources_ActionSync =
  passOnSuccess({
...
Scenarios.Azure_ResourceManager_Models_Resources_TopLevelTracked_Resources_ListBySubscription =
  passOnSuccess({
...
Scenarios.Azure_ResourceManager_Models_Resources_NestedProxyResources_listByTopResource =
  passOnSuccess({
