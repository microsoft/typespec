...
public final class UnionIntLiteralsImpl {
    ...
    public interface UnionIntLiteralsService {
        ...
        Response<UnionIntLiteralProperty> getAllSync(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<UnionIntLiteralProperty> getDefaultSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions);
