...
public final class FloatLiteralsImpl {
    ...
    public interface FloatLiteralsService {
        ...
        Response<FloatLiteralProperty> getAllSync(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<FloatLiteralProperty> getDefaultSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions);
