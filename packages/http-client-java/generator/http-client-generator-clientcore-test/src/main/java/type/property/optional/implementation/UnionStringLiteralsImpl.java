...
public final class UnionStringLiteralsImpl {
    ...
    public interface UnionStringLiteralsService {
        ...
        Response<UnionStringLiteralProperty> getAllSync(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<UnionStringLiteralProperty> getDefaultSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions);
