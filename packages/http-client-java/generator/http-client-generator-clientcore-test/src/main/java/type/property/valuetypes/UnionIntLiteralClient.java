...
public final class UnionIntLiteralClient {
    ...
    public Response<UnionIntLiteralProperty> getWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UnionIntLiteral.get", requestContext,
    ...
    public Response<Void> putWithResponse(UnionIntLiteralProperty body, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UnionIntLiteral.put", requestContext,
