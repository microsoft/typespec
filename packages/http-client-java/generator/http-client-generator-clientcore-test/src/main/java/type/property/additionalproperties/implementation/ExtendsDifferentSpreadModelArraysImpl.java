...
public final class ExtendsDifferentSpreadModelArraysImpl {
    ...
    ExtendsDifferentSpreadModelArraysImpl(AdditionalPropertiesClientImpl client) {
        this.service = ExtendsDifferentSpreadModelArraysService.getNewInstance(client.getHttpPipeline());
        this.client = client;
    ...
    public interface ExtendsDifferentSpreadModelArraysService {
        static ExtendsDifferentSpreadModelArraysService getNewInstance(HttpPipeline pipeline) {
            try {
                ...
                return (ExtendsDifferentSpreadModelArraysService) clazz.getMethod("getNewInstance", HttpPipeline.class)
        ...
        Response<Void> put(@HostParam("endpoint") String endpoint, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") DifferentSpreadModelArrayDerived body, RequestContext requestContext);
    }
    ...
    public Response<DifferentSpreadModelArrayDerived> getWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "Type.Property.AdditionalProperties.ExtendsDifferentSpreadModelArray.get", requestContext,
            updatedContext -> {
    ...
    public Response<Void> putWithResponse(DifferentSpreadModelArrayDerived body, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "Type.Property.AdditionalProperties.ExtendsDifferentSpreadModelArray.put", requestContext,
            updatedContext -> {
