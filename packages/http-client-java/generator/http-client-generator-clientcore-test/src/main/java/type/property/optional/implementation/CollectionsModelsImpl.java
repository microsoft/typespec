...
public final class CollectionsModelsImpl {
    ...
    public interface CollectionsModelsService {
        ...
        Response<CollectionsModelProperty> getAllSync(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<CollectionsModelProperty> getDefaultSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions);
