...
public final class PetInsurancesImpl {
    ...
    public interface PetInsurancesService {
        static PetInsurancesService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("petstore.implementation.PetInsurancesServiceImpl");
                return (PetInsurancesService) clazz.getMethod("getNewInstance", HttpPipeline.class)
