...
import encode.array.implementation.ArrayClientImpl;
 ...
 */
@ServiceClientBuilder(serviceClients = { ArrayClient.class })
public final class ArrayClientBuilder implements HttpTrait<ArrayClientBuilder>, ProxyTrait<ArrayClientBuilder>,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("encode-array.properties");
    ...
    public ArrayClient buildArrayClient() {
        ...
        return new ArrayClient(innerClient.getProperties(), innerClient.getInstrumentation());
    }
}
