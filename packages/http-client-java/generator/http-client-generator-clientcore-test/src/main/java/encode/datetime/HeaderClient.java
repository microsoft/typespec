...
public final class HeaderClient {
    ...
    public Response<Void> defaultMethodWithResponse(OffsetDateTime value, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Encode.Datetime.DatetimeClient.default", requestContext,
    ...
    public Response<Void> rfc3339WithResponse(OffsetDateTime value, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Encode.Datetime.DatetimeClient.rfc3339", requestContext,
    ...
    public Response<Void> rfc7231WithResponse(OffsetDateTime value, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Encode.Datetime.DatetimeClient.rfc7231", requestContext,
    ...
    public Response<Void> unixTimestampWithResponse(OffsetDateTime value, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Encode.Datetime.DatetimeClient.unixTimestamp",
            requestContext, updatedContext -> this.serviceClient.unixTimestampWithResponse(value, updatedContext));
    }
    ...
    public Response<Void> unixTimestampArrayWithResponse(List<OffsetDateTime> value, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Encode.Datetime.DatetimeClient.unixTimestampArray",
            requestContext, updatedContext -> this.serviceClient.unixTimestampArrayWithResponse(value, updatedContext));
    }
