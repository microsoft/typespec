...
public final class OAuth2Client {
    ...
    public Response<Void> validWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Authentication.OAuth2.OAuth2Client.valid", requestContext,
    ...
    public Response<Void> invalidWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Authentication.OAuth2.OAuth2Client.invalid", requestContext,
