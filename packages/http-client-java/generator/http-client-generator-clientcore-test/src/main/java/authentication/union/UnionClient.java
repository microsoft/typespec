...
public final class UnionClient {
    ...
    public Response<Void> validKeyWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Authentication.Union.UnionClient.validKey", requestContext,
    ...
    public Response<Void> validTokenWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("Authentication.Union.UnionClient.validToken",
            requestContext, updatedContext -> this.serviceClient.validTokenWithResponse(updatedContext));
    }
