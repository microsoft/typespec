...
public final class PathParametersSimpleExpansionExplodeClient {
    ...
    public Response<Void> primitiveWithResponse(String param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersSimpleExpansionExplode.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersSimpleExpansionExplode.array", requestContext,
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersSimpleExpansionExplode.record",
