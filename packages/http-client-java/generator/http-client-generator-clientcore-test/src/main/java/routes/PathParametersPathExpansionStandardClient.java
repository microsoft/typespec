...
public final class PathParametersPathExpansionStandardClient {
    ...
    public Response<Void> primitiveWithResponse(String param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersPathExpansionStandard.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersPathExpansionStandard.array", requestContext,
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersPathExpansionStandard.record", requestContext,
