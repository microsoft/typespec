...
public final class PathParametersMatrixExpansionStandardClient {
    ...
    public Response<Void> primitiveWithResponse(String param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersMatrixExpansionStandard.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersMatrixExpansionStandard.array",
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("PathParametersMatrixExpansionStandard.record",
