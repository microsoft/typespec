...
public final class ModelWithRenamedUnwrappedModelArray implements XmlSerializable<ModelWithRenamedUnwrappedModelArray> {
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public ModelWithRenamedUnwrappedModelArray(List<SimpleModel> items) {
        this.items = items;
    }
    ...
    public XmlWriter toXml(XmlWriter xmlWriter, String rootElementName) throws XMLStreamException {
        ...
        if (this.items != null) {
            for (SimpleModel element : this.items) {
                xmlWriter.writeXml(element, "ModelItem");
            }
        }
     ...
     * @throws XMLStreamException If an error occurs while reading the ModelWithRenamedUnwrappedModelArray.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public static ModelWithRenamedUnwrappedModelArray fromXml(XmlReader xmlReader) throws XMLStreamException {
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public static ModelWithRenamedUnwrappedModelArray fromXml(XmlReader xmlReader, String rootElementName)
        ...
        return xmlReader.readObject(finalRootElementName, reader -> {
            ...
            while (reader.nextElement() != XmlToken.END_ELEMENT) {
                ...
                if ("ModelItem".equals(elementName.getLocalPart())) {
                    ...
                    items.add(SimpleModel.fromXml(reader, "ModelItem"));
                } else {
                    reader.skipElement();
                }
            }
            return new ModelWithRenamedUnwrappedModelArray(items);
        });
    }
}
