...
public final class TodoClientBuilder implements HttpTrait<TodoClientBuilder>, ProxyTrait<TodoClientBuilder>,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("todo.properties");
    ...
    private TodoClientImpl buildInnerClient() {
        ...
        TodoClientImpl client = new TodoClientImpl(createHttpPipeline(), instrumentation, this.endpoint);
        return client;
    }
    ...
    public UsersClient buildUsersClient() {
        TodoClientImpl innerClient = buildInnerClient();
        return new UsersClient(innerClient.getUsers(), innerClient.getInstrumentation());
    }
    ...
    public TodoItemsClient buildTodoItemsClient() {
        TodoClientImpl innerClient = buildInnerClient();
        return new TodoItemsClient(innerClient.getTodoItems(), innerClient.getInstrumentation());
    }
    ...
    public TodoItemsAttachmentsClient buildTodoItemsAttachmentsClient() {
        TodoClientImpl innerClient = buildInnerClient();
        return new TodoItemsAttachmentsClient(innerClient.getTodoItemsAttachments(), innerClient.getInstrumentation());
    }
}
