...
public class ErrorClientModel {
    ...
    public static final ClientModel MANAGEMENT_ERROR
        = new ClientModel.Builder().name(FluentType.MANAGEMENT_ERROR.getName())
            .packageName("com.azure.core.management.exception")
            .properties(Arrays.asList(
                new ClientModelProperty.Builder().name("code")
                    .serializedName("code")
                    ...
                    .build(),
                new ClientModelProperty.Builder().name("message")
                    ...
                    .clientType(ClassType.STRING)
                    .build(),
                new ClientModelProperty.Builder().name("target")
                    ...
                    .clientType(ClassType.STRING)
                    .build(),
                new ClientModelProperty.Builder().name("details")
                    ...
                    .build(),
                new ClientModelProperty.Builder().name("additionalInfo")
    ...
    private static final ClientModel ADDITIONAL_INFO
        = new ClientModel.Builder().name(FluentType.ADDITIONAL_INFO.getName())
            .packageName("com.azure.core.management.exception")
            .properties(Arrays.asList(
                new ClientModelProperty.Builder().name("type")
                    .serializedName("type")
                    ...
                    .clientType(ClassType.STRING)
                    .build(),
                new ClientModelProperty.Builder().name("info")
                    .serializedName("info")
