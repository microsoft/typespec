...
public class FluentApplyMethod extends FluentBaseMethod {
    ...
    public FluentApplyMethod(FluentResourceModel model, FluentMethodType type, List<ClientMethodParameter> parameters,
        ...
        super(model, type, "apply", "Executes the update request.", "the updated resource.", parameters,
            resourceLocalVariables, collection, collectionMethod, resourceLocalVariablesDefinedInClass, false);
    }
}
