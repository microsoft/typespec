...
$generateScript = {
  ...
  if (($tspFile -match "(azure[\\/]core[\\/]basic|parameters[\\/]basic|payload[\\/]head|payload[\\/]multipart|versioning[\\/]added)[\\/](main|client)\.tsp$") -or ($tspFile -match "tsp[\\/]request-headers\.tsp$")) {
