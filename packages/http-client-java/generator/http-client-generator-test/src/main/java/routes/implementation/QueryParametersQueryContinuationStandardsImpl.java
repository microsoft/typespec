...
public final class QueryParametersQueryContinuationStandardsImpl {
    ...
    QueryParametersQueryContinuationStandardsImpl(RoutesClientImpl client) {
        this.service = RestProxy.create(QueryParametersQueryContinuationStandardsService.class,
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "RoutesClientQueryParametersQueryContinuationStandards")
    public interface QueryParametersQueryContinuationStandardsService {
        @Get("/routes/query/query-continuation/standard/primitive?fixed=true")
        ...
        @Get("/routes/query/query-continuation/standard/array?fixed=true")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Get("/routes/query/query-continuation/standard/record?fixed=true")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
