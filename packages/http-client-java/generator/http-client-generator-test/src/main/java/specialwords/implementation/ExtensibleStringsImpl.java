...
public final class ExtensibleStringsImpl {
    ...
    ExtensibleStringsImpl(SpecialWordsClientImpl client) {
        this.service
            = RestProxy.create(ExtensibleStringsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "SpecialWordsClientExtensibleStrings")
