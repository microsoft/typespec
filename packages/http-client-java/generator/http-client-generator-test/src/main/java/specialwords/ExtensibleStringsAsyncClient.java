...
import specialwords.models.ExtensibleString;
...
public final class ExtensibleStringsAsyncClient {
    @Generated
    private final ExtensibleStringsImpl serviceClient;

    /**
     * Initializes an instance of ExtensibleStringsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ExtensibleStringsAsyncClient(ExtensibleStringsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> putExtensibleStringValue(String accept, ExtensibleString body) {
