...
public final class UnionClientImpl {
    ...
    public interface UnionClientService {
        @Get("/authentication/noauth/union/valid")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> validNoAuth(@HostParam("endpoint") String endpoint, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> validNoAuthSync(@HostParam("endpoint") String endpoint, RequestOptions requestOptions,
            Context context);

        @Get("/authentication/noauth/union/validtoken")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
    ...
    public Mono<Response<Void>> validNoAuthWithResponseAsync(RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.validNoAuth(this.getEndpoint(), requestOptions, context));
    }
    ...
    public Response<Void> validNoAuthWithResponse(RequestOptions requestOptions) {
        return service.validNoAuthSync(this.getEndpoint(), requestOptions, Context.NONE);
    }
