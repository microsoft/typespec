...
public final class QueryClient {
    ...
    public Response<Void> int32SecondsLargerUnitWithResponse(Duration input, RequestOptions requestOptions) {
        return this.serviceClient.int32SecondsLargerUnitWithResponse(input, requestOptions);
    }
    ...
    public Response<Void> floatSecondsLargerUnitWithResponse(Duration input, RequestOptions requestOptions) {
        return this.serviceClient.floatSecondsLargerUnitWithResponse(input, requestOptions);
    }
    ...
    public void int32SecondsLargerUnit(Duration input) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        int32SecondsLargerUnitWithResponse(input, requestOptions).getValue();
    }
    ...
    public void floatSecondsLargerUnit(Duration input) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        floatSecondsLargerUnitWithResponse(input, requestOptions).getValue();
    }
