...
public final class NoEnvelopeCustomDiscriminatorsImpl {
    ...
    NoEnvelopeCustomDiscriminatorsImpl(DiscriminatedClientImpl client) {
        this.service = RestProxy.create(NoEnvelopeCustomDiscriminatorsService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DiscriminatedClientNoEnvelopeCustomDiscriminators")
    public interface NoEnvelopeCustomDiscriminatorsService {
        @Get("/type/union/discriminated/no-envelope/custom-discriminator")
        ...
        @Put("/type/union/discriminated/no-envelope/custom-discriminator")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
