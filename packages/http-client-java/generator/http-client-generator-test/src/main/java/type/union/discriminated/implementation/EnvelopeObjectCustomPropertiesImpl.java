...
public final class EnvelopeObjectCustomPropertiesImpl {
    ...
    EnvelopeObjectCustomPropertiesImpl(DiscriminatedClientImpl client) {
        this.service = RestProxy.create(EnvelopeObjectCustomPropertiesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DiscriminatedClientEnvelopeObjectCustomProperties")
    public interface EnvelopeObjectCustomPropertiesService {
        @Get("/type/union/discriminated/envelope/object/custom-properties")
        ...
        @Put("/type/union/discriminated/envelope/object/custom-properties")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
