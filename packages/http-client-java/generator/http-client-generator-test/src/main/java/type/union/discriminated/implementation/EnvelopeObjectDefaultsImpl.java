...
public final class EnvelopeObjectDefaultsImpl {
    ...
    EnvelopeObjectDefaultsImpl(DiscriminatedClientImpl client) {
        this.service = RestProxy.create(EnvelopeObjectDefaultsService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DiscriminatedClientEnvelopeObjectDefaults")
    public interface EnvelopeObjectDefaultsService {
        @Get("/type/union/discriminated/envelope/object/default")
        ...
        @Put("/type/union/discriminated/envelope/object/default")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
