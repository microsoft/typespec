...
public final class BulletPointsModel implements JsonSerializable<BulletPointsModel> {
     ...
     * <ul><li>Simple bullet point. This bullet point is going to be very long to test how text wrapping is handled in
     * bullet points within documentation comments. It should properly indent the wrapped lines.</li>
     * <li>Bullet point with <b>bold text</b>. This bullet point is also intentionally long to see how the formatting is
     * preserved when the text wraps onto multiple</li>
     * <li>Bullet point with <i>italic text</i>. Similar to the previous points, this one is extended to ensure that the
     * wrapping and formatting are correctly applied in the output.</li>
     ...
     * <li><b>Bold bullet point</b></li>
     * <li><i>Italic bullet point</i>.</li></ul>
     * 
