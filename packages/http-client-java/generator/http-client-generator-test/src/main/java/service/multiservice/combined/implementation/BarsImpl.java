...
public final class BarsImpl {
    ...
    /**
     * The interface defining all the services for CombinedBars to be used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "CombinedBars")
    public interface BarsService {
        @Get("/service/multi-service/service-b/bar/test")
