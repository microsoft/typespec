...
public final class ModelWithRenamedPropertyValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithRenamedPropertyValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedPropertyValueAsyncClient(ModelWithRenamedPropertyValuesImpl serviceClient) {
     ...
     * @return §1.2 — Contains a scalar property with a custom XML name on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedProperty> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedProperty.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithRenamedProperty input) {
