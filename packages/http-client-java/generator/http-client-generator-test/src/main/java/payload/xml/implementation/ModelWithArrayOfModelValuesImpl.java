...
public final class ModelWithArrayOfModelValuesImpl {
    ...
    ModelWithArrayOfModelValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithArrayOfModelValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithArrayOfModelValues")
    public interface ModelWithArrayOfModelValuesService {
        @Get("/payload/xml/modelWithArrayOfModel")
        ...
        @Put("/payload/xml/modelWithArrayOfModel")
     ...
     * @return §4.1 — Contains an array of models along with {@link Response} on successful completion of {@link Mono}.
     */
