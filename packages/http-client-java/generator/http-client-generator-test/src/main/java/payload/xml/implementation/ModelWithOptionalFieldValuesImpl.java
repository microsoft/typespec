...
public final class ModelWithOptionalFieldValuesImpl {
    ...
    ModelWithOptionalFieldValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithOptionalFieldValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithOptionalFieldValues")
    public interface ModelWithOptionalFieldValuesService {
        @Get("/payload/xml/modelWithOptionalField")
        ...
        @Put("/payload/xml/modelWithOptionalField")
     ...
     * @return contains an optional field along with {@link Response} on successful completion of {@link Mono}.
     */
