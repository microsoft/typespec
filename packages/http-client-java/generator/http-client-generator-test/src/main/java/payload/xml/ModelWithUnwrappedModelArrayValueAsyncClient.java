...
public final class ModelWithUnwrappedModelArrayValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithUnwrappedModelArrayValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithUnwrappedModelArrayValueAsyncClient(ModelWithUnwrappedModelArrayValuesImpl serviceClient) {
     ...
     * @return §4.2 — Contains an unwrapped array of models on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithUnwrappedModelArray> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithUnwrappedModelArray.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithUnwrappedModelArray input) {
