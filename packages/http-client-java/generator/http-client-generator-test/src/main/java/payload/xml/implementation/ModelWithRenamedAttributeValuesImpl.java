...
public final class ModelWithRenamedAttributeValuesImpl {
    ...
    ModelWithRenamedAttributeValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithRenamedAttributeValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithRenamedAttributeValues")
    public interface ModelWithRenamedAttributeValuesService {
        @Get("/payload/xml/modelWithRenamedAttribute")
        ...
        @Put("/payload/xml/modelWithRenamedAttribute")
     ...
     * @return §5.2 — Contains a renamed XML attribute along with {@link Response} on successful completion of {@link Mono}.
     */
