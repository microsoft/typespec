...
public final class ModelWithRenamedFieldsValuesImpl {
    ...
    ModelWithRenamedFieldsValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithRenamedFieldsValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithRenamedFieldsValues")
    public interface ModelWithRenamedFieldsValuesService {
        @Get("/payload/xml/modelWithRenamedFields")
        ...
        @Put("/payload/xml/modelWithRenamedFields")
