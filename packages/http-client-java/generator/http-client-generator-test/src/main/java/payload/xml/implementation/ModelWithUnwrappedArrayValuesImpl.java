...
public final class ModelWithUnwrappedArrayValuesImpl {
    ...
    ModelWithUnwrappedArrayValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithUnwrappedArrayValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithUnwrappedArrayValues")
    public interface ModelWithUnwrappedArrayValuesService {
        @Get("/payload/xml/modelWithUnwrappedArray")
        ...
        @Put("/payload/xml/modelWithUnwrappedArray")
     ...
     * @return §3.2 — Contains fields of wrapped and unwrapped arrays of primitive types along with {@link Response} on successful completion of {@link Mono}.
     */
