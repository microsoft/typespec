...
public final class ModelWithDatetimeValuesImpl {
    ...
    ModelWithDatetimeValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithDatetimeValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithDatetimeValues")
    public interface ModelWithDatetimeValuesService {
        @Get("/payload/xml/modelWithDatetime")
        ...
        @Put("/payload/xml/modelWithDatetime")
     ...
     * @return contains datetime properties with different encodings along with {@link Response} on successful completion of {@link Mono}.
     */
