...
public final class ServerDrivenPaginationsImpl {
    ...
    public Mono<Response<BinaryData>> linkWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.link(this.client.getEndpoint(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> linkWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.linkSync(this.client.getEndpoint(), accept, requestOptions, Context.NONE);
    }
}
