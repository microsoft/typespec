...
public final class ModelWithRenamedFieldsValueAsyncClient {
     ...
     * @return §1.3, §2.3 — Contains fields of the same type that have different XML representation on successful
    ...
    public Mono<ModelWithRenamedFields> get() {
        ...
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedFields.class, XML_SERIALIZER));
    }
