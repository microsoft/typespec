...
public final class ModelWithNamespaceValuesImpl {
    ...
    ModelWithNamespaceValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithNamespaceValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithNamespaceValues")
    public interface ModelWithNamespaceValuesService {
        @Get("/payload/xml/modelWithNamespace")
        ...
        @Put("/payload/xml/modelWithNamespace")
     ...
     * @return §6.1, §7.1 — Contains fields with XML namespace on the model along with {@link Response} on successful completion of {@link Mono}.
     */
