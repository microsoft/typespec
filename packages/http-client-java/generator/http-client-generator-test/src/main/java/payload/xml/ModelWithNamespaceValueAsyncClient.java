...
public final class ModelWithNamespaceValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithNamespaceValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithNamespaceValueAsyncClient(ModelWithNamespaceValuesImpl serviceClient) {
     ...
     * @return §6.1, §7.1 — Contains fields with XML namespace on the model on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithNamespace> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithNamespace.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithNamespace input) {
