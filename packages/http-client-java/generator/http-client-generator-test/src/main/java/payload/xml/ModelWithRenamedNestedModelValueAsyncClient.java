...
public final class ModelWithRenamedNestedModelValueAsyncClient {
    ...
    /**
     * Initializes an instance of ModelWithRenamedNestedModelValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedNestedModelValueAsyncClient(ModelWithRenamedNestedModelValuesImpl serviceClient) {
     ...
     * @return §2.2 — Contains a property whose type has on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedNestedModel> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedNestedModel.class, XML_SERIALIZER));
    }
