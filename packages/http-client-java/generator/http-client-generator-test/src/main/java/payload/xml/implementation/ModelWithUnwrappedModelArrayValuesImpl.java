...
public final class ModelWithUnwrappedModelArrayValuesImpl {
    ...
    ModelWithUnwrappedModelArrayValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithUnwrappedModelArrayValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithUnwrappedModelArrayValues")
    public interface ModelWithUnwrappedModelArrayValuesService {
        ...
        @Put("/payload/xml/modelWithUnwrappedModelArray")
