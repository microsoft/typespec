...
public final class ModelWithRenamedUnwrappedModelArrayValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithRenamedUnwrappedModelArrayValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedUnwrappedModelArrayValueAsyncClient(ModelWithRenamedUnwrappedModelArrayValuesImpl serviceClient) {
     ...
     * @return §4.4 — Contains an unwrapped array of models with a custom item name along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return §4.4 — Contains an unwrapped array of models with a custom item name on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedUnwrappedModelArray> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedUnwrappedModelArray.class,
                XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithRenamedUnwrappedModelArray input) {
