...
public final class ModelWithRenamedArraysValueAsyncClient {
    ...
    /**
     * Initializes an instance of ModelWithRenamedArraysValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedArraysValueAsyncClient(ModelWithRenamedArraysValuesImpl serviceClient) {
     ...
     * @return §3.3, §3.4 — Contains fields of wrapped and unwrapped arrays of primitive types that have different XML
     * representations on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedArrays> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedArrays.class, XML_SERIALIZER));
    }
