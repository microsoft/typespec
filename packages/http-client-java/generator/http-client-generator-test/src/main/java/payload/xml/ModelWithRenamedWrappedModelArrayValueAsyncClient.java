...
public final class ModelWithRenamedWrappedModelArrayValueAsyncClient {
    ...
    /**
     * Initializes an instance of ModelWithRenamedWrappedModelArrayValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedWrappedModelArrayValueAsyncClient(ModelWithRenamedWrappedModelArrayValuesImpl serviceClient) {
     ...
     * @return §4.3 — Contains a wrapped array of models with a custom wrapper name on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedWrappedModelArray> get() {
