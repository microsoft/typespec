...
public final class ModelWithArrayOfModelValueAsyncClient {
    ...
    /**
     * Initializes an instance of ModelWithArrayOfModelValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithArrayOfModelValueAsyncClient(ModelWithArrayOfModelValuesImpl serviceClient) {
     ...
     * @return §4.1 — Contains an array of models on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithArrayOfModel> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithArrayOfModel.class));
    }
