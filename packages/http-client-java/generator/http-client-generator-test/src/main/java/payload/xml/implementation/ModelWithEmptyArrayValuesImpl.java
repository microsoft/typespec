...
public final class ModelWithEmptyArrayValuesImpl {
    ...
    ModelWithEmptyArrayValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithEmptyArrayValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithEmptyArrayValues")
    public interface ModelWithEmptyArrayValuesService {
        @Get("/payload/xml/modelWithEmptyArray")
        ...
        @Put("/payload/xml/modelWithEmptyArray")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return contains an array of models that's supposed to be sent/received as an empty XML element along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
