...
/**
 * Initializes a new instance of the asynchronous HeadClient type.
 */
@ServiceClient(builder = HeadClientBuilder.class, isAsync = true)
public final class HeadAsyncClient {
    @Generated
    private final HeadClientImpl serviceClient;

    /**
     * Initializes an instance of HeadAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    HeadAsyncClient(HeadClientImpl serviceClient) {
