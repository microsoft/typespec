...
public final class XmlErrorValuesImpl {
    ...
    XmlErrorValuesImpl(XmlClientImpl client) {
        this.service
            = RestProxy.create(XmlErrorValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientXmlErrorValues")
    public interface XmlErrorValuesService {
        @Get("/payload/xml/error")
