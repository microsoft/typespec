...
public final class ModelWithRenamedArraysValuesImpl {
    ...
    ModelWithRenamedArraysValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithRenamedArraysValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithRenamedArraysValues")
    public interface ModelWithRenamedArraysValuesService {
        @Get("/payload/xml/modelWithRenamedArrays")
        ...
        @Put("/payload/xml/modelWithRenamedArrays")
