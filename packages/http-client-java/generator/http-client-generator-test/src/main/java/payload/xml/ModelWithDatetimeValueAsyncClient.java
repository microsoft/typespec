...
public final class ModelWithDatetimeValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithDatetimeValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithDatetimeValueAsyncClient(ModelWithDatetimeValuesImpl serviceClient) {
     ...
     * @return contains datetime properties with different encodings on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithDatetime> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithDatetime.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithDatetime input) {
