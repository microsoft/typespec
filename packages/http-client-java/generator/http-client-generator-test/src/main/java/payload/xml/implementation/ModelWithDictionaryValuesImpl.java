...
public final class ModelWithDictionaryValuesImpl {
    ...
    ModelWithDictionaryValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithDictionaryValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithDictionaryValues")
    public interface ModelWithDictionaryValuesService {
        @Get("/payload/xml/modelWithDictionary")
        ...
        @Put("/payload/xml/modelWithDictionary")
     ...
     * @return contains a dictionary of key value pairs along with {@link Response} on successful completion of {@link Mono}.
     */
