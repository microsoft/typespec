...
public final class HeadClientImpl {
     ...
     */
    public HeadClientImpl(String endpoint) {
     ...
     * @param endpoint Service host.
     */
    public HeadClientImpl(HttpPipeline httpPipeline, String endpoint) {
     ...
     * @param endpoint Service host.
     */
    public HeadClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint) {
        this.httpPipeline = httpPipeline;
        this.serializerAdapter = serializerAdapter;
        this.endpoint = endpoint;
        this.service = RestProxy.create(HeadClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "HeadClient")
    public interface HeadClientService {
        @Head("/payload/head/content-type-header-in-response")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> contentTypeHeaderInResponse(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> contentTypeHeaderInResponseSync(@HostParam("endpoint") String endpoint,
            RequestOptions requestOptions, Context context);
    }
