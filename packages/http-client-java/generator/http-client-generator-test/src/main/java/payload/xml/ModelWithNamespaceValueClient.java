...
public final class ModelWithNamespaceValueClient {
     ...
     */
    @Generated
    ModelWithNamespaceValueClient(ModelWithNamespaceValuesImpl serviceClient) {
    ...
    public ModelWithNamespace get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(ModelWithNamespace.class);
    }
