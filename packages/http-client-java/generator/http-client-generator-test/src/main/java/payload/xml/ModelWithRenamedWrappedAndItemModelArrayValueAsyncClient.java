...
public final class ModelWithRenamedWrappedAndItemModelArrayValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithRenamedWrappedAndItemModelArrayValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedWrappedAndItemModelArrayValueAsyncClient(
        ModelWithRenamedWrappedAndItemModelArrayValuesImpl serviceClient) {
     ...
     * @return §4.5 — Contains a wrapped array of models with custom wrapper and item names on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedWrappedAndItemModelArray> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedWrappedAndItemModelArray.class,
                XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithRenamedWrappedAndItemModelArray input) {
