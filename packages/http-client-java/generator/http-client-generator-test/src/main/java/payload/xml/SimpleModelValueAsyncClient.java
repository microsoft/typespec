...
public final class SimpleModelValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of SimpleModelValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SimpleModelValueAsyncClient(SimpleModelValuesImpl serviceClient) {
     ...
     * @return §1.1 — Contains fields of primitive types on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleModel> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SimpleModel.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(SimpleModel input) {
