...
public final class ModelWithRenamedUnwrappedModelArrayValuesImpl {
    ...
    ModelWithRenamedUnwrappedModelArrayValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithRenamedUnwrappedModelArrayValuesService.class,
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithRenamedUnwrappedModelArrayValues")
    public interface ModelWithRenamedUnwrappedModelArrayValuesService {
        @Get("/payload/xml/modelWithRenamedUnwrappedModelArray")
        ...
        @Put("/payload/xml/modelWithRenamedUnwrappedModelArray")
