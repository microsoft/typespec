...
public final class ModelWithNamespaceOnPropertiesValuesImpl {
    ...
    ModelWithNamespaceOnPropertiesValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithNamespaceOnPropertiesValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithNamespaceOnPropertiesValues")
    public interface ModelWithNamespaceOnPropertiesValuesService {
        @Get("/payload/xml/modelWithNamespaceOnProperties")
        ...
        @Put("/payload/xml/modelWithNamespaceOnProperties")
     ...
     * @return §6.2, §7.2 — Contains fields with different XML namespaces on individual properties along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return §6.2, §7.2 — Contains fields with different XML namespaces on individual properties along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
