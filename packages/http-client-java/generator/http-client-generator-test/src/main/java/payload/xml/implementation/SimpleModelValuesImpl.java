...
public final class SimpleModelValuesImpl {
    ...
    SimpleModelValuesImpl(XmlClientImpl client) {
        this.service
            = RestProxy.create(SimpleModelValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientSimpleModelValues")
    public interface SimpleModelValuesService {
        @Get("/payload/xml/simpleModel")
     ...
     * @return §1.1 — Contains fields of primitive types along with {@link Response} on successful completion of {@link Mono}.
     */
