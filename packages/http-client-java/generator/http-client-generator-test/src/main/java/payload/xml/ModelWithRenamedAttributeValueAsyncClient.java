...
public final class ModelWithRenamedAttributeValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithRenamedAttributeValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithRenamedAttributeValueAsyncClient(ModelWithRenamedAttributeValuesImpl serviceClient) {
     ...
     * @return §5.2 — Contains a renamed XML attribute on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithRenamedAttribute> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithRenamedAttribute.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithRenamedAttribute input) {
