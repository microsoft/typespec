...
public final class ModelWithOptionalFieldValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithOptionalFieldValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithOptionalFieldValueAsyncClient(ModelWithOptionalFieldValuesImpl serviceClient) {
     ...
     * @return contains an optional field on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithOptionalField> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithOptionalField.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithOptionalField input) {
