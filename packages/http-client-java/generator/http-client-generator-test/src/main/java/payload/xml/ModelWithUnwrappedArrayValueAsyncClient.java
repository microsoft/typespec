...
public final class ModelWithUnwrappedArrayValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithUnwrappedArrayValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithUnwrappedArrayValueAsyncClient(ModelWithUnwrappedArrayValuesImpl serviceClient) {
     ...
     * @return §3.2 — Contains fields of wrapped and unwrapped arrays of primitive types on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithUnwrappedArray> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithUnwrappedArray.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithUnwrappedArray input) {
