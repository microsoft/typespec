...
public final class ModelWithSimpleArraysValuesImpl {
    ...
    ModelWithSimpleArraysValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithSimpleArraysValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithSimpleArraysValues")
    public interface ModelWithSimpleArraysValuesService {
        @Get("/payload/xml/modelWithSimpleArrays")
        ...
        @Put("/payload/xml/modelWithSimpleArrays")
     ...
     * @return §3.1 — Contains fields of arrays of primitive types along with {@link Response} on successful completion of {@link Mono}.
     */
