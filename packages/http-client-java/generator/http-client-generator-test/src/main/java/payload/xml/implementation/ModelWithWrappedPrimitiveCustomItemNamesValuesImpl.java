...
public final class ModelWithWrappedPrimitiveCustomItemNamesValuesImpl {
    ...
    ModelWithWrappedPrimitiveCustomItemNamesValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithWrappedPrimitiveCustomItemNamesValuesService.class,
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithWrappedPrimitiveCustomItemNamesValues")
    public interface ModelWithWrappedPrimitiveCustomItemNamesValuesService {
        @Get("/payload/xml/modelWithWrappedPrimitiveCustomItemNames")
        ...
        @Put("/payload/xml/modelWithWrappedPrimitiveCustomItemNames")
