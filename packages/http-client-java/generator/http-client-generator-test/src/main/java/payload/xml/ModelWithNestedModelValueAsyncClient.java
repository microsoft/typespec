...
public final class ModelWithNestedModelValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithNestedModelValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithNestedModelValueAsyncClient(ModelWithNestedModelValuesImpl serviceClient) {
     ...
     * @return §2.1 — Contains a property that references another model on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithNestedModel> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithNestedModel.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithNestedModel input) {
