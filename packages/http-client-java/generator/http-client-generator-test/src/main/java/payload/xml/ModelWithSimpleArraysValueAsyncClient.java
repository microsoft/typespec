...
public final class ModelWithSimpleArraysValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithSimpleArraysValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithSimpleArraysValueAsyncClient(ModelWithSimpleArraysValuesImpl serviceClient) {
     ...
     * @return §3.1 — Contains fields of arrays of primitive types on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithSimpleArrays> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithSimpleArrays.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithSimpleArrays input) {
