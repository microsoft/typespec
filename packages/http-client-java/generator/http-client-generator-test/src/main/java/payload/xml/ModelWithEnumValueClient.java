...
public final class ModelWithEnumValueClient {
     ...
     */
    @Generated
    ModelWithEnumValueClient(ModelWithEnumValuesImpl serviceClient) {
    ...
    public ModelWithEnum get() {
        ...
        return getWithResponse(requestOptions).getValue().toObject(ModelWithEnum.class, XML_SERIALIZER);
    }
