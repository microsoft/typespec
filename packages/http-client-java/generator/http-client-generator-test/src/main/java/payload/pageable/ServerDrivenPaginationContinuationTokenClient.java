...
public final class ServerDrivenPaginationContinuationTokenClient {
    ...
    public PagedIterable<BinaryData> requestQueryNestedResponseBody(RequestOptions requestOptions) {
        return this.serviceClient.requestQueryNestedResponseBody(requestOptions);
    }
    ...
    public PagedIterable<BinaryData> requestHeaderNestedResponseBody(RequestOptions requestOptions) {
        return this.serviceClient.requestHeaderNestedResponseBody(requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Pet> requestQueryNestedResponseBody(String token, String foo, String bar) {
        ...
        return serviceClient.requestQueryNestedResponseBody(requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(Pet.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Pet> requestHeaderNestedResponseBody(String token, String foo, String bar) {
        ...
        return serviceClient.requestHeaderNestedResponseBody(requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(Pet.class));
    }
