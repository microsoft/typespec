...
public final class ModelWithNamespaceOnPropertiesValueAsyncClient {
    ...
    /**
     * Initializes an instance of ModelWithNamespaceOnPropertiesValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithNamespaceOnPropertiesValueAsyncClient(ModelWithNamespaceOnPropertiesValuesImpl serviceClient) {
     ...
     * @return §6.2, §7.2 — Contains fields with different XML namespaces on individual properties on successful
     * completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithNamespaceOnProperties> get() {
