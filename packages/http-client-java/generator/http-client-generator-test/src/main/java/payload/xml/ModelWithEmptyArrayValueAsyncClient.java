...
public final class ModelWithEmptyArrayValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithEmptyArrayValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithEmptyArrayValueAsyncClient(ModelWithEmptyArrayValuesImpl serviceClient) {
     ...
     * @return contains an array of models that's supposed to be sent/received as an empty XML element on successful
     * completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithEmptyArray> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithEmptyArray.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithEmptyArray input) {
