...
public final class ModelWithRenamedNestedModelValuesImpl {
    ...
    ModelWithRenamedNestedModelValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithRenamedNestedModelValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithRenamedNestedModelValues")
    public interface ModelWithRenamedNestedModelValuesService {
        @Get("/payload/xml/modelWithRenamedNestedModel")
        ...
        @Put("/payload/xml/modelWithRenamedNestedModel")
     ...
     * @return §2.2 — Contains a property whose type has along with {@link Response} on successful completion of {@link Mono}.
     */
