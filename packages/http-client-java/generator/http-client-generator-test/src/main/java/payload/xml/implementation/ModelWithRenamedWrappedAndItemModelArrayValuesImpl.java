...
public final class ModelWithRenamedWrappedAndItemModelArrayValuesImpl {
    ...
    ModelWithRenamedWrappedAndItemModelArrayValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithRenamedWrappedAndItemModelArrayValuesService.class,
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithRenamedWrappedAndItemModelArrayValues")
    public interface ModelWithRenamedWrappedAndItemModelArrayValuesService {
        ...
        @Put("/payload/xml/modelWithRenamedWrappedAndItemModelArray")
