...
public final class ModelWithDictionaryValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithDictionaryValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithDictionaryValueAsyncClient(ModelWithDictionaryValuesImpl serviceClient) {
     ...
     * @return contains a dictionary of key value pairs on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithDictionary> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithDictionary.class, XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithDictionary input) {
