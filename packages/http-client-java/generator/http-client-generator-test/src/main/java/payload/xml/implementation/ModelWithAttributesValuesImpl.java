...
public final class ModelWithAttributesValuesImpl {
    ...
    ModelWithAttributesValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithAttributesValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithAttributesValues")
    public interface ModelWithAttributesValuesService {
        @Get("/payload/xml/modelWithAttributes")
        ...
        @Put("/payload/xml/modelWithAttributes")
