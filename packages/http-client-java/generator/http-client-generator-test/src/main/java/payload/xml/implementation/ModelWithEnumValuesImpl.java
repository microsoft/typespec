...
public final class ModelWithEnumValuesImpl {
    ...
    ModelWithEnumValuesImpl(XmlClientImpl client) {
        this.service = RestProxy.create(ModelWithEnumValuesService.class, client.getHttpPipeline(),
     ...
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "XmlClientModelWithEnumValues")
    public interface ModelWithEnumValuesService {
        @Get("/payload/xml/modelWithEnum")
     ...
     * @return contains a single property with an enum value along with {@link Response} on successful completion of {@link Mono}.
     */
