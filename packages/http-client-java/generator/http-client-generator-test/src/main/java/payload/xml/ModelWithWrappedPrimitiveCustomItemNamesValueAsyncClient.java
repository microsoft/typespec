...
public final class ModelWithWrappedPrimitiveCustomItemNamesValueAsyncClient {
    @Generated
    ...
    /**
     * Initializes an instance of ModelWithWrappedPrimitiveCustomItemNamesValueAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ModelWithWrappedPrimitiveCustomItemNamesValueAsyncClient(
        ModelWithWrappedPrimitiveCustomItemNamesValuesImpl serviceClient) {
     ...
     * @return §3.5 — Contains a wrapped primitive array with custom wrapper and item names along with {@link Response} on successful completion of {@link Mono}.
     */
    @Generated
     ...
     * @return §3.5 — Contains a wrapped primitive array with custom wrapper and item names on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelWithWrappedPrimitiveCustomItemNames> get() {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ModelWithWrappedPrimitiveCustomItemNames.class,
                XML_SERIALIZER));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> put(ModelWithWrappedPrimitiveCustomItemNames input) {
