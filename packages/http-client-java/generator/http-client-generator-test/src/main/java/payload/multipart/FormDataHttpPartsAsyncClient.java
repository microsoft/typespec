...
public final class FormDataHttpPartsAsyncClient {
    @Generated
    private final FormDataHttpPartsImpl serviceClient;

    /**
     * Initializes an instance of FormDataHttpPartsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    FormDataHttpPartsAsyncClient(FormDataHttpPartsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> jsonArrayAndFileArrayWithResponse(ComplexHttpPartsModelRequest body,
