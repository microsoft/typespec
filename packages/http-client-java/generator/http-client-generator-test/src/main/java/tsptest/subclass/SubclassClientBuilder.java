...
public final class SubclassClientBuilder implements HttpTrait<SubclassClientBuilder>,
    ConfigurationTrait<SubclassClientBuilder>, EndpointTrait<SubclassClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("tsptest-subclass.properties");
