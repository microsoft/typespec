...
/**
 * Initializes a new instance of the ArmVersionedClientImpl type.
 */
@ServiceClient(builder = ArmVersionedClientBuilder.class)
public final class ArmVersionedClientImpl implements ArmVersionedClient {
    /**
     * Service host.
     */
    ...
    /**
     * Initializes an instance of ArmVersionedClient client.
     * 
     ...
     */
    ArmVersionedClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ArmVersionedClientImpl.class);
}
