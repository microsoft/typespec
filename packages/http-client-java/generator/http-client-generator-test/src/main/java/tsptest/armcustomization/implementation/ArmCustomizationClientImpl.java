...
/**
 * Initializes a new instance of the ArmCustomizationClientImpl type.
 */
@ServiceClient(builder = ArmCustomizationClientBuilder.class)
public final class ArmCustomizationClientImpl implements ArmCustomizationClient {
    /**
     * Service host.
     */
    ...
    /**
     * Initializes an instance of ArmCustomizationClient client.
     * 
     ...
     */
    ArmCustomizationClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ArmCustomizationClientImpl.class);
}
