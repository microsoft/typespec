...
public final class EtagHeadersOptionalBodyAsyncClient {
    ...
    public Mono<Response<BinaryData>> putWithOptionalBodyWithResponse(String format,
        RequestConditions requestConditions, RequestOptions requestOptions) {
        return this.serviceClient.putWithOptionalBodyWithResponseAsync(format, requestConditions, requestOptions);
    }
    ...
    public Mono<Resource> putWithOptionalBody(String format, String filter, OffsetDateTime timestamp, Resource body,
        ...
        return putWithOptionalBodyWithResponse(format, requestConditions, requestOptions).flatMap(FluxUtil::toMono)
    ...
    public Mono<Resource> putWithOptionalBody(String format) {
        // Generated convenience method for putWithOptionalBodyWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return putWithOptionalBodyWithResponse(format, null, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(Resource.class));
    }
}
