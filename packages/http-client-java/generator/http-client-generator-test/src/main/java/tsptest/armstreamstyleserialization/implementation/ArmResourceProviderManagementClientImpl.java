 ...
 */
@ServiceClient(builder = ArmResourceProviderManagementClientBuilder.class)
public final class ArmResourceProviderManagementClientImpl implements ArmResourceProviderManagementClient {
    /**
     * Service host.
     */
     ...
     */
    ArmResourceProviderManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ArmResourceProviderManagementClientImpl.class);
}
