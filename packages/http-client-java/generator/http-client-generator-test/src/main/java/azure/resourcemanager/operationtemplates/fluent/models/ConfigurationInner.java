 ...
 */
@Fluent
public final class ConfigurationInner extends Resource {
    /*
     ...
     */
    @Override
    public ConfigurationInner withLocation(String location) {
     ...
     */
    @Override
    public ConfigurationInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedConfigurationInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedConfigurationInner.withTags(tags);
