...
import azure.clientgenerator.core.clientlocation.parameter.implementation.BlobOperationsImpl;
...
/**
 * Initializes a new instance of the asynchronous MoveMethodParameterToClient type.
 */
@ServiceClient(builder = MoveMethodParameterToClientBuilder.class, isAsync = true)
public final class MoveMethodParameterToAsyncClient {
    @Generated
    private final BlobOperationsImpl serviceClient;

    /**
     * Initializes an instance of MoveMethodParameterToAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MoveMethodParameterToAsyncClient(BlobOperationsImpl serviceClient) {
