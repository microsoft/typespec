...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MethodSubscriptionIdClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MethodSubscriptionIdClientOperations to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MethodSubscriptionIdClientOperations")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Azure.ResourceManager.MethodSubscriptionId/operations")
