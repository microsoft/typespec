...
/**
 * Initializes a new instance of the CombinedImpl type.
 */
@ServiceClient(builder = CombinedBuilder.class)
public final class CombinedImpl implements Combined {
    /**
     * Service host.
     */
     ...
     */
    CombinedImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CombinedImpl.class);
}
