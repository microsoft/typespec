...
/**
 * Initializes a new instance of the asynchronous ChildClient type.
 */
@ServiceClient(builder = ChildClientBuilder.class, isAsync = true)
public final class ChildAsyncClient {
    @Generated
    private final ChildClientImpl serviceClient;

    /**
     * Initializes an instance of ChildAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ChildAsyncClient(ChildClientImpl serviceClient) {
