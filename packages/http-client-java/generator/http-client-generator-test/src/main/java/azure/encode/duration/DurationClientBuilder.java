 ...
 */
@ServiceClientBuilder(serviceClients = { DurationClient.class, DurationAsyncClient.class })
public final class DurationClientBuilder implements HttpTrait<DurationClientBuilder>,
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-encode-duration.properties");
    ...
    private DurationClientImpl buildInnerClient() {
        ...
        DurationClientImpl client
            = new DurationClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), localEndpoint);
        return client;
    }
    ...
    /**
     * Builds an instance of DurationAsyncClient class.
     * 
     * @return an instance of DurationAsyncClient.
     */
    @Generated
    public DurationAsyncClient buildAsyncClient() {
        return new DurationAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of DurationClient class.
     * 
     * @return an instance of DurationClient.
     */
    @Generated
    public DurationClient buildClient() {
        return new DurationClient(buildInnerClient());
    }
