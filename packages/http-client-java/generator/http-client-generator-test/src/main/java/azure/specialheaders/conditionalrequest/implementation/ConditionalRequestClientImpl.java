...
package azure.specialheaders.conditionalrequest.implementation;
...
public final class ConditionalRequestClientImpl {
    ...
    public interface ConditionalRequestClientService {
        @Post("/azure/special-headers/conditional-request/if-match")
        ...
        @Post("/azure/special-headers/conditional-request/if-none-match")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Post("/azure/special-headers/conditional-request/custom-if-match")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> postCustomIfMatch(@HostParam("endpoint") String endpoint, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> postCustomIfMatchSync(@HostParam("endpoint") String endpoint, RequestOptions requestOptions,
            Context context);

        @Post("/azure/special-headers/conditional-request/custom-if-none-match")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> postCustomIfNoneMatch(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> postCustomIfNoneMatchSync(@HostParam("endpoint") String endpoint, RequestOptions requestOptions,
            Context context);
    }
     ...
     * <caption>Header Parameters</caption>
     * <tr><th>Name</th><th>Type</th><th>Required</th><th>Description</th></tr>
     * <tr><td>x-ms-blob-if-match</td><td>String</td><td>No</td><td>The request should only proceed if an entity matches
     * this string.</td></tr>
     * </table>
     * You can add these to a request with {@link RequestOptions#addHeader}
     * 
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> postCustomIfMatchWithResponseAsync(RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.postCustomIfMatch(this.getEndpoint(), requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> postCustomIfMatchWithResponse(RequestOptions requestOptions) {
        return service.postCustomIfMatchSync(this.getEndpoint(), requestOptions, Context.NONE);
    }
     ...
     * <caption>Header Parameters</caption>
     * <tr><th>Name</th><th>Type</th><th>Required</th><th>Description</th></tr>
     * <tr><td>x-ms-blob-if-none-match</td><td>String</td><td>No</td><td>The request should only proceed if no entity
     * matches this string.</td></tr>
     * </table>
     * You can add these to a request with {@link RequestOptions#addHeader}
     * 
     * @param requestOptions The options to configure the HTTP request before HTTP client sends it.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> postCustomIfNoneMatchWithResponseAsync(RequestOptions requestOptions) {
        return FluxUtil
            .withContext(context -> service.postCustomIfNoneMatch(this.getEndpoint(), requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> postCustomIfNoneMatchWithResponse(RequestOptions requestOptions) {
        return service.postCustomIfNoneMatchSync(this.getEndpoint(), requestOptions, Context.NONE);
    }
}
