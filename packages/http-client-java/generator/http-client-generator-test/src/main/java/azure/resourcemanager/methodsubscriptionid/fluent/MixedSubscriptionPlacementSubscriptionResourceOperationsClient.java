...
public interface MixedSubscriptionPlacementSubscriptionResourceOperationsClient {
    ...
    Response<SubscriptionResourceInner> getWithResponse(String subscriptionId, String subscriptionResourceName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SubscriptionResourceInner get(String subscriptionId, String subscriptionResourceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SubscriptionResourceInner> putWithResponse(String subscriptionId, String subscriptionResourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SubscriptionResourceInner put(String subscriptionId, String subscriptionResourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String subscriptionId, String subscriptionResourceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String subscriptionId, String subscriptionResourceName);
}
