...
public final class ModelsImpl {
     ...
     */
    ModelsImpl(ExactNameClientImpl client) {
        this.service = RestProxy.create(ModelsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ExactNameClientModels to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ExactNameClientModels")
    public interface ModelsService {
        @Post("/azure/client-generator-core/exact-name/model")
