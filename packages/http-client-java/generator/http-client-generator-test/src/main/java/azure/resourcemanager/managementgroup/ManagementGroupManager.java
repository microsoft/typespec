...
import azure.resourcemanager.managementgroup.implementation.ManagementGroupClientBuilder;
...
/**
 * Entry point to ManagementGroupManager.
 * Arm Resource Provider management API.
 */
public final class ManagementGroupManager {
    private ManagementGroupChildResources managementGroupChildResources;

    private final ManagementGroupClient clientObject;

    private ManagementGroupManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        this.clientObject = new ManagementGroupClientBuilder().pipeline(httpPipeline)
     ...
     */
    public static ManagementGroupManager authenticate(TokenCredential credential, AzureProfile profile) {
     ...
     * @return the ManagementGroup service API instance.
     */
    public static ManagementGroupManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new ManagementGroupManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create ManagementGroupManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new ManagementGroupManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-managementgroup-generated.properties");
