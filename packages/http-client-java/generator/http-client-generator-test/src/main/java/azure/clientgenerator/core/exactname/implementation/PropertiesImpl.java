...
public final class PropertiesImpl {
     ...
     */
    PropertiesImpl(ExactNameClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ExactNameClientProperties to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ExactNameClientProperties")
    public interface PropertiesService {
        @Post("/azure/client-generator-core/exact-name/property")
