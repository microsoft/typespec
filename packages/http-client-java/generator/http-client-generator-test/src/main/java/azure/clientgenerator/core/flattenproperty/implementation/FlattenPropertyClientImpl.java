...
package azure.clientgenerator.core.flattenproperty.implementation;
...
public final class FlattenPropertyClientImpl {
    ...
    public interface FlattenPropertyClientService {
        ...
        @Put("/azure/client-generator-core/flatten-property/flattenUnknownModel")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> putFlattenUnknownModel(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") BinaryData input, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> putFlattenUnknownModelSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") BinaryData input, RequestOptions requestOptions, Context context);

        @Put("/azure/client-generator-core/flatten-property/flattenReadOnlyModel")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> putFlattenReadOnlyModel(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> putFlattenReadOnlyModelSync(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") BinaryData body, RequestOptions requestOptions, Context context);
    }
    ...
    public Mono<Response<BinaryData>> putFlattenUnknownModelWithResponseAsync(BinaryData input,
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.putFlattenUnknownModel(this.getEndpoint(), contentType, accept,
            input, requestOptions, context));
    }
    ...
    public Response<BinaryData> putFlattenUnknownModelWithResponse(BinaryData input, RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.putFlattenUnknownModelSync(this.getEndpoint(), contentType, accept, input, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> putFlattenReadOnlyModelWithResponseAsync(BinaryData body,
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.putFlattenReadOnlyModel(this.getEndpoint(), contentType, accept,
    ...
    public Response<BinaryData> putFlattenReadOnlyModelWithResponse(BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.putFlattenReadOnlyModelSync(this.getEndpoint(), contentType, accept, body, requestOptions,
            Context.NONE);
    }
}
