...
public final class ParentClientBuilder implements HttpTrait<ParentClientBuilder>,
     ...
     */
    @Generated
    public ParentClientBuilder blobName(String blobName) {
    ...
    private ParentClientImpl buildInnerClient() {
        ...
        ParentClientImpl client = new ParentClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(),
    ...
    public ParentAsyncClient buildAsyncClient() {
        return new ParentAsyncClient(buildInnerClient().getChildClients());
    }
    ...
    public ParentClient buildClient() {
        return new ParentClient(buildInnerClient().getChildClients());
    }
