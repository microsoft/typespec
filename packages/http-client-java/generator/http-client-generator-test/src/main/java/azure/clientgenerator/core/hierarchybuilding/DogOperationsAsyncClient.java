...
public final class DogOperationsAsyncClient {
    @Generated
    private final DogOperationsImpl serviceClient;

    /**
     * Initializes an instance of DogOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    DogOperationsAsyncClient(DogOperationsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> updateDogAsDogWithResponse(BinaryData dog, RequestOptions requestOptions) {
        return this.serviceClient.updateDogAsDogWithResponseAsync(dog, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Dog> updateDogAsDog(Dog dog) {
        // Generated convenience method for updateDogAsDogWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return updateDogAsDogWithResponse(BinaryData.fromObject(dog), requestOptions).flatMap(FluxUtil::toMono)
