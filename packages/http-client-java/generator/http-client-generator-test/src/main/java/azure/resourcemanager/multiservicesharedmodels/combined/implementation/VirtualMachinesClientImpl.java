...
public final class VirtualMachinesClientImpl implements VirtualMachinesClient {
    ...
    public interface VirtualMachinesService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachinesShared/{vmName}")
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachinesShared/{vmName}")
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vmName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, vmName, contentType, accept, resource, Context.NONE);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vmName,
        ...
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, vmName, contentType, accept, resource, context);
    }
