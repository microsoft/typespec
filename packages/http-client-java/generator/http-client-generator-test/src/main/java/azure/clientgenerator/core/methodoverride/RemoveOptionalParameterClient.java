...
public final class RemoveOptionalParameterClient {
    @Generated
    private final RemoveOptionalParametersImpl serviceClient;

    /**
     * Initializes an instance of RemoveOptionalParameterClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    RemoveOptionalParameterClient(RemoveOptionalParametersImpl serviceClient) {
    ...
    public Response<Void> removeOptionalWithResponse(String param1, RequestOptions requestOptions) {
        return this.serviceClient.removeOptionalWithResponse(param1, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void removeOptional(String param1) {
        // Generated convenience method for removeOptionalWithResponse
        RequestOptions requestOptions = new RequestOptions();
        removeOptionalWithResponse(param1, requestOptions).getValue();
    }
