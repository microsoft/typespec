...
public final class SseClientBuilder
    ...
    @Generated
    @Override
    public SseClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public SseClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public SseClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public SseClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public SseClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    private SseClientImpl buildInnerClient() {
        ...
        SseClientImpl client
            = new SseClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), localEndpoint);
        return client;
    }
    ...
    /**
     * Builds an instance of UnnamedAsyncClient class.
     * 
     * @return an instance of UnnamedAsyncClient.
     */
    @Generated
    public UnnamedAsyncClient buildUnnamedAsyncClient() {
        return new UnnamedAsyncClient(buildInnerClient().getUnnameds());
    }

    /**
     * Builds an instance of NamedAsyncClient class.
     * 
     * @return an instance of NamedAsyncClient.
     */
    @Generated
    public NamedAsyncClient buildNamedAsyncClient() {
        return new NamedAsyncClient(buildInnerClient().getNameds());
    }

    /**
     * Builds an instance of RetrieveAsyncClient class.
     * 
     * @return an instance of RetrieveAsyncClient.
     */
    @Generated
    public RetrieveAsyncClient buildRetrieveAsyncClient() {
        return new RetrieveAsyncClient(buildInnerClient().getRetrieves());
    }
    ...
    public UnnamedClient buildUnnamedClient() {
        return new UnnamedClient(buildInnerClient().getUnnameds());
    }
    ...
    public NamedClient buildNamedClient() {
        return new NamedClient(buildInnerClient().getNameds());
    }
