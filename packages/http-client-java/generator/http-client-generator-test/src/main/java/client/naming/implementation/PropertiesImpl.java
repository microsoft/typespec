...
public final class PropertiesImpl {
     ...
     */
    PropertiesImpl(NamingClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for NamingClientProperties to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "NamingClientProperties")
    ...
    public Mono<Response<Void>> compatibleWithEncodedNameWithResponseAsync(BinaryData body,
        ...
        final String contentType = "application/json";
        return FluxUtil.withContext(context -> service.compatibleWithEncodedName(this.client.getEndpoint(), contentType,
    ...
    public Response<Void> compatibleWithEncodedNameWithResponse(BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.compatibleWithEncodedNameSync(this.client.getEndpoint(), contentType, body, requestOptions,
            Context.NONE);
    }
}
