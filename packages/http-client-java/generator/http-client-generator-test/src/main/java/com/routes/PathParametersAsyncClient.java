...
public final class PathParametersAsyncClient {
    @Generated
    private final PathParametersImpl serviceClient;

    /**
     * Initializes an instance of PathParametersAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    PathParametersAsyncClient(PathParametersImpl serviceClient) {
