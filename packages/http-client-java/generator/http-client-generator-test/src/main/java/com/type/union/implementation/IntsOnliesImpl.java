...
public final class IntsOnliesImpl {
    ...
    public interface IntsOnliesService {
        ...
        Mono<Response<Void>> send(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @BodyParam("application/json") BinaryData sendRequest6,
            RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<Void>> sendWithResponseAsync(BinaryData sendRequest6, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
            context -> service.send(this.client.getEndpoint(), contentType, sendRequest6, requestOptions, context));
    }
    ...
    public Response<Void> sendWithResponse(BinaryData sendRequest6, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.sendSync(this.client.getEndpoint(), contentType, sendRequest6, requestOptions, Context.NONE);
    }
}
