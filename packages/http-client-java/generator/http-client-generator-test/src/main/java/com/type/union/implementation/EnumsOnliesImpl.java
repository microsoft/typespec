...
public final class EnumsOnliesImpl {
    ...
    public interface EnumsOnliesService {
        ...
        Mono<Response<Void>> send(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @BodyParam("application/json") BinaryData sendRequest3,
            RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<Void>> sendWithResponseAsync(BinaryData sendRequest3, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
            context -> service.send(this.client.getEndpoint(), contentType, sendRequest3, requestOptions, context));
    }
    ...
    public Response<Void> sendWithResponse(BinaryData sendRequest3, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.sendSync(this.client.getEndpoint(), contentType, sendRequest3, requestOptions, Context.NONE);
    }
}
