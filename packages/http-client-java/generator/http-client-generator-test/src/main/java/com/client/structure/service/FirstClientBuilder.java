...
@ServiceClientBuilder(
    serviceClients = {
        ...
        Group3Client.class,
        Group4Client.class,
        FirstAsyncClient.class,
        Group3AsyncClient.class,
        Group4AsyncClient.class })
public final class FirstClientBuilder implements HttpTrait<FirstClientBuilder>, ConfigurationTrait<FirstClientBuilder>,
    ...
    /**
     * Builds an instance of Group3AsyncClient class.
     * 
     * @return an instance of Group3AsyncClient.
     */
    @Generated
    public Group3AsyncClient buildGroup3AsyncClient() {
        return new Group3AsyncClient(buildInnerClient().getGroup3s());
    }

    /**
     * Builds an instance of Group4AsyncClient class.
     * 
     * @return an instance of Group4AsyncClient.
     */
    @Generated
    public Group4AsyncClient buildGroup4AsyncClient() {
        return new Group4AsyncClient(buildInnerClient().getGroup4s());
    }
    ...
    public Group3Client buildGroup3Client() {
        return new Group3Client(buildInnerClient().getGroup3s());
    }
    ...
    public Group4Client buildGroup4Client() {
        return new Group4Client(buildInnerClient().getGroup4s());
    }
