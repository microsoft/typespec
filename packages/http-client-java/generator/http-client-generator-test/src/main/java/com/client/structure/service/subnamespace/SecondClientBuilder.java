...
@ServiceClientBuilder(
    serviceClients = { SecondClient.class, Group5Client.class, SecondAsyncClient.class, Group5AsyncClient.class })
public final class SecondClientBuilder implements HttpTrait<SecondClientBuilder>,
    ...
    /**
     * Builds an instance of Group5AsyncClient class.
     * 
     * @return an instance of Group5AsyncClient.
     */
    @Generated
    public Group5AsyncClient buildGroup5AsyncClient() {
        return new Group5AsyncClient(buildInnerClient().getGroup5s());
    }
    ...
    public Group5Client buildGroup5Client() {
        return new Group5Client(buildInnerClient().getGroup5s());
    }
