...
package cadl.response.implementation;

import cadl.response.ResponseServiceVersion;
import cadl.response.models.OperationDetails1;
import cadl.response.models.OperationDetails2;
import cadl.response.models.Resource;
...
public final class ResponseClientImpl {
    ...
    public PollerFlux<BinaryData, BinaryData> beginLroInvalidPollResponseAsync(BinaryData request,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new cadl.response.implementation.OperationLocationPollingStrategy<>(
    ...
    public SyncPoller<BinaryData, BinaryData> beginLroInvalidPollResponse(BinaryData request,
        ...
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            ...
            new cadl.response.implementation.SyncOperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.getHttpPipeline())
                    .setEndpoint("{endpoint}".replace("{endpoint}", this.getEndpoint()))
                    .setContext(requestOptions != null && requestOptions.getContext() != null
                        ? requestOptions.getContext()
