...
/**
 * Initializes a new instance of the IndividuallyNestedWithPathClient type.
 */
public final class IndividuallyNestedWithPathClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IndividuallyNestedWithPathClientService service;
    ...
    /**
     * Initializes an instance of IndividuallyNestedWithPathClient client.
     * 
     * @param endpoint Service host.
     * @param blobName
     */
    public IndividuallyNestedWithPathClientImpl(String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyNestedWithPathClientImpl(HttpPipeline httpPipeline, String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyNestedWithPathClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        String endpoint, String blobName) {
        this.httpPipeline = httpPipeline;
        this.serializerAdapter = serializerAdapter;
        this.endpoint = endpoint;
        this.blobName = blobName;
        this.service = RestProxy.create(IndividuallyNestedWithPathClientService.class, this.httpPipeline,
            this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for IndividuallyNestedWithPathClient to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "IndividuallyNestedWithPathClient")
    public interface IndividuallyNestedWithPathClientService {
        ...
        @Delete("/azure/client-generator-core/client-initialization/individually/nested-default-individually/{blobName}")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
