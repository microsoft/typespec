...
/**
 * Initializes a new instance of the IndividuallyNestedWithQueryClient type.
 */
public final class IndividuallyNestedWithQueryClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IndividuallyNestedWithQueryClientService service;
    ...
    /**
     * Initializes an instance of IndividuallyNestedWithQueryClient client.
     * 
     * @param endpoint Service host.
     * @param blobName
     */
    public IndividuallyNestedWithQueryClientImpl(String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyNestedWithQueryClientImpl(HttpPipeline httpPipeline, String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyNestedWithQueryClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        String endpoint, String blobName) {
        this.httpPipeline = httpPipeline;
        this.serializerAdapter = serializerAdapter;
        this.endpoint = endpoint;
        this.blobName = blobName;
        this.service = RestProxy.create(IndividuallyNestedWithQueryClientService.class, this.httpPipeline,
            this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for IndividuallyNestedWithQueryClient to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "IndividuallyNestedWithQueryClient")
    public interface IndividuallyNestedWithQueryClientService {
        ...
        @Delete("/azure/client-generator-core/client-initialization/individually/nested-default-individually-query/delete-resource")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
