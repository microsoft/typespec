...
/**
 * Initializes a new instance of the asynchronous IndividuallyNestedWithPathClient type.
 */
@ServiceClient(builder = IndividuallyNestedWithPathClientBuilder.class, isAsync = true)
public final class IndividuallyNestedWithPathAsyncClient {
    @Generated
    private final IndividuallyNestedWithPathClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyNestedWithPathAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyNestedWithPathAsyncClient(IndividuallyNestedWithPathClientImpl serviceClient) {
