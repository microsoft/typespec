...
/**
 * Initializes a new instance of the asynchronous IndividuallyNestedWithHeaderClient type.
 */
@ServiceClient(builder = IndividuallyNestedWithHeaderClientBuilder.class, isAsync = true)
public final class IndividuallyNestedWithHeaderAsyncClient {
    @Generated
    private final IndividuallyNestedWithHeaderClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyNestedWithHeaderAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyNestedWithHeaderAsyncClient(IndividuallyNestedWithHeaderClientImpl serviceClient) {
