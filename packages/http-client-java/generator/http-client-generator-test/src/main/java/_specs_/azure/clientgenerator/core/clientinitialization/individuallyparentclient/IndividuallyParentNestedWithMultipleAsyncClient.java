...
/**
 * Initializes a new instance of the asynchronous IndividuallyParentNestedWithMultipleClient type.
 */
@ServiceClient(builder = IndividuallyParentNestedWithMultipleClientBuilder.class, isAsync = true)
public final class IndividuallyParentNestedWithMultipleAsyncClient {
    @Generated
    private final IndividuallyParentNestedWithMultipleClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyParentNestedWithMultipleAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyParentNestedWithMultipleAsyncClient(IndividuallyParentNestedWithMultipleClientImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> getStandaloneWithResponse(RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getStandalone() {
