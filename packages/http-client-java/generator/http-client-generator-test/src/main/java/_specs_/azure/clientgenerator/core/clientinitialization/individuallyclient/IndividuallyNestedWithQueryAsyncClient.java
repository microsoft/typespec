...
/**
 * Initializes a new instance of the asynchronous IndividuallyNestedWithQueryClient type.
 */
@ServiceClient(builder = IndividuallyNestedWithQueryClientBuilder.class, isAsync = true)
public final class IndividuallyNestedWithQueryAsyncClient {
    @Generated
    private final IndividuallyNestedWithQueryClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyNestedWithQueryAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyNestedWithQueryAsyncClient(IndividuallyNestedWithQueryClientImpl serviceClient) {
