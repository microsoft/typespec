...
/**
 * Initializes a new instance of the asynchronous IndividuallyParentNestedWithPathClient type.
 */
@ServiceClient(builder = IndividuallyParentNestedWithPathClientBuilder.class, isAsync = true)
public final class IndividuallyParentNestedWithPathAsyncClient {
    @Generated
    private final IndividuallyParentNestedWithPathClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyParentNestedWithPathAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyParentNestedWithPathAsyncClient(IndividuallyParentNestedWithPathClientImpl serviceClient) {
