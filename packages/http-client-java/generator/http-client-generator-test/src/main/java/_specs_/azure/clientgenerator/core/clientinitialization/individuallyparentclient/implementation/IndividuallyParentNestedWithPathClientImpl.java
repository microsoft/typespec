...
/**
 * Initializes a new instance of the IndividuallyParentNestedWithPathClient type.
 */
public final class IndividuallyParentNestedWithPathClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IndividuallyParentNestedWithPathClientService service;
    ...
    /**
     * Initializes an instance of IndividuallyParentNestedWithPathClient client.
     * 
     * @param endpoint Service host.
     * @param blobName
     */
    public IndividuallyParentNestedWithPathClientImpl(String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyParentNestedWithPathClientImpl(HttpPipeline httpPipeline, String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyParentNestedWithPathClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        String endpoint, String blobName) {
        this.httpPipeline = httpPipeline;
        this.serializerAdapter = serializerAdapter;
        this.endpoint = endpoint;
        this.blobName = blobName;
        this.service = RestProxy.create(IndividuallyParentNestedWithPathClientService.class, this.httpPipeline,
            this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for IndividuallyParentNestedWithPathClient to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "IndividuallyParentNestedWithPathClient")
    public interface IndividuallyParentNestedWithPathClientService {
        ...
        @Delete("/azure/client-generator-core/client-initialization/individually-parent/nested-default-individually-parent/{blobName}")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
