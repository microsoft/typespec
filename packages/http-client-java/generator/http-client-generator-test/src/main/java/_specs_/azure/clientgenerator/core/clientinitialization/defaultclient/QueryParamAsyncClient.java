...
/**
 * Initializes a new instance of the asynchronous QueryParamClient type.
 */
@ServiceClient(builder = QueryParamClientBuilder.class, isAsync = true)
public final class QueryParamAsyncClient {
    @Generated
    private final QueryParamClientImpl serviceClient;

    /**
     * Initializes an instance of QueryParamAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    QueryParamAsyncClient(QueryParamClientImpl serviceClient) {
