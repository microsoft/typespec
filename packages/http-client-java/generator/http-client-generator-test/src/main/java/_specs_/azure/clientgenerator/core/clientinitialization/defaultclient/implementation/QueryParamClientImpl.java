...
/**
 * Initializes a new instance of the QueryParamClient type.
 */
public final class QueryParamClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final QueryParamClientService service;
    ...
    /**
     * Initializes an instance of QueryParamClient client.
     * 
     * @param endpoint Service host.
     * @param blobName
     */
    public QueryParamClientImpl(String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public QueryParamClientImpl(HttpPipeline httpPipeline, String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public QueryParamClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint,
        String blobName) {
        this.httpPipeline = httpPipeline;
        this.serializerAdapter = serializerAdapter;
        this.endpoint = endpoint;
        this.blobName = blobName;
        this.service = RestProxy.create(QueryParamClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for QueryParamClient to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "QueryParamClient")
    public interface QueryParamClientService {
        ...
        @Delete("/azure/client-generator-core/client-initialization/default/query/delete-resource")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
