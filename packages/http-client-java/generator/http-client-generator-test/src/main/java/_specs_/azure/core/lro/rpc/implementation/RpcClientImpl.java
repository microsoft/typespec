...
package _specs_.azure.core.lro.rpc.implementation;

import _specs_.azure.core.lro.rpc.RpcServiceVersion;
...
public final class RpcClientImpl {
    ...
    public PollerFlux<BinaryData, BinaryData> beginLongRunningRpcAsync(BinaryData body, RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new _specs_.azure.core.lro.rpc.implementation.OperationLocationPollingStrategy<>(
    ...
    public SyncPoller<BinaryData, BinaryData> beginLongRunningRpc(BinaryData body, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            ...
            new _specs_.azure.core.lro.rpc.implementation.SyncOperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.getHttpPipeline())
                    .setEndpoint("{endpoint}".replace("{endpoint}", this.getEndpoint()))
                    .setContext(requestOptions != null && requestOptions.getContext() != null
                        ? requestOptions.getContext()
