...
/**
 * Initializes a new instance of the asynchronous IndividuallyNestedWithMultipleClient type.
 */
@ServiceClient(builder = IndividuallyNestedWithMultipleClientBuilder.class, isAsync = true)
public final class IndividuallyNestedWithMultipleAsyncClient {
    @Generated
    private final IndividuallyNestedWithMultipleClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyNestedWithMultipleAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyNestedWithMultipleAsyncClient(IndividuallyNestedWithMultipleClientImpl serviceClient) {
