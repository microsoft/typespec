...
/**
 * Initializes a new instance of the IndividuallyParentNestedWithQueryClient type.
 */
public final class IndividuallyParentNestedWithQueryClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IndividuallyParentNestedWithQueryClientService service;
    ...
    /**
     * Initializes an instance of IndividuallyParentNestedWithQueryClient client.
     * 
     * @param endpoint Service host.
     * @param blobName
     */
    public IndividuallyParentNestedWithQueryClientImpl(String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyParentNestedWithQueryClientImpl(HttpPipeline httpPipeline, String endpoint, String blobName) {
     ...
     * @param blobName
     */
    public IndividuallyParentNestedWithQueryClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        String endpoint, String blobName) {
        this.httpPipeline = httpPipeline;
        this.serializerAdapter = serializerAdapter;
        this.endpoint = endpoint;
        this.blobName = blobName;
        this.service = RestProxy.create(IndividuallyParentNestedWithQueryClientService.class, this.httpPipeline,
            this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for IndividuallyParentNestedWithQueryClient to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "IndividuallyParentNestedWithQueryClient")
    public interface IndividuallyParentNestedWithQueryClientService {
        ...
        Mono<Response<Void>> withQuery(@HostParam("endpoint") String endpoint, @QueryParam("blobName") String blobName,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> withQuerySync(@HostParam("endpoint") String endpoint, @QueryParam("blobName") String blobName,
            RequestOptions requestOptions, Context context);
        ...
        Mono<Response<BinaryData>> getStandalone(@HostParam("endpoint") String endpoint,
            @QueryParam("blobName") String blobName, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        @Delete("/azure/client-generator-core/client-initialization/individually-parent/nested-default-individually-parent-query/delete-resource")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<Void>> deleteStandalone(@HostParam("endpoint") String endpoint,
            @QueryParam("blobName") String blobName, RequestOptions requestOptions, Context context);
