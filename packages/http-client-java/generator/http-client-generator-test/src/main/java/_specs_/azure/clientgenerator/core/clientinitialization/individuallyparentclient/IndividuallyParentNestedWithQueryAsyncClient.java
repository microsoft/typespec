...
/**
 * Initializes a new instance of the asynchronous IndividuallyParentNestedWithQueryClient type.
 */
@ServiceClient(builder = IndividuallyParentNestedWithQueryClientBuilder.class, isAsync = true)
public final class IndividuallyParentNestedWithQueryAsyncClient {
    @Generated
    private final IndividuallyParentNestedWithQueryClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyParentNestedWithQueryAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyParentNestedWithQueryAsyncClient(IndividuallyParentNestedWithQueryClientImpl serviceClient) {
