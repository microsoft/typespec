...
import _specs_.azure.clientgenerator.core.clientinitialization.defaultclient.models.Input;
...
/**
 * Initializes a new instance of the asynchronous MultipleParamsClient type.
 */
@ServiceClient(builder = MultipleParamsClientBuilder.class, isAsync = true)
public final class MultipleParamsAsyncClient {
    @Generated
    private final MultipleParamsClientImpl serviceClient;

    /**
     * Initializes an instance of MultipleParamsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MultipleParamsAsyncClient(MultipleParamsClientImpl serviceClient) {
