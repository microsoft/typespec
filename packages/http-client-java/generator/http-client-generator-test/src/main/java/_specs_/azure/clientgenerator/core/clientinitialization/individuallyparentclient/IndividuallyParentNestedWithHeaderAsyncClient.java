...
/**
 * Initializes a new instance of the asynchronous IndividuallyParentNestedWithHeaderClient type.
 */
@ServiceClient(builder = IndividuallyParentNestedWithHeaderClientBuilder.class, isAsync = true)
public final class IndividuallyParentNestedWithHeaderAsyncClient {
    @Generated
    private final IndividuallyParentNestedWithHeaderClientImpl serviceClient;

    /**
     * Initializes an instance of IndividuallyParentNestedWithHeaderAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndividuallyParentNestedWithHeaderAsyncClient(IndividuallyParentNestedWithHeaderClientImpl serviceClient) {
