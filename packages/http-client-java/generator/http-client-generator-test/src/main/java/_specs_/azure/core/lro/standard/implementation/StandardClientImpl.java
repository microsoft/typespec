...
package _specs_.azure.core.lro.standard.implementation;

import _specs_.azure.core.lro.standard.StandardServiceVersion;
...
public final class StandardClientImpl {
    ...
    public PollerFlux<BinaryData, BinaryData> beginCreateOrReplaceAsync(String name, BinaryData resource,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new _specs_.azure.core.lro.standard.implementation.OperationLocationPollingStrategy<>(
    ...
    public SyncPoller<BinaryData, BinaryData> beginCreateOrReplace(String name, BinaryData resource,
        ...
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            ...
            new _specs_.azure.core.lro.standard.implementation.SyncOperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.getHttpPipeline())
                    .setEndpoint("{endpoint}".replace("{endpoint}", this.getEndpoint()))
                    .setContext(requestOptions != null && requestOptions.getContext() != null
                        ? requestOptions.getContext()
