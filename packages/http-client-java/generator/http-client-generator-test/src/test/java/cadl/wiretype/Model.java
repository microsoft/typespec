...
public final class Model {
    ...
    // java.io.UncheckedIOException: com.fasterxml.jackson.databind.exc.InvalidDefinitionException: Cannot construct
    // instance of `com.cadl.wiretype.Model` (no Creators, like default constructor, exist): cannot deserialize from
    // Object value (no delegate- or property-based Creator)
    private Model() {
    }

    // Alternatively, Jackson also fine with this private constructor. However, we seems do not really want this added
    // complexity.
//    @JsonCreator
