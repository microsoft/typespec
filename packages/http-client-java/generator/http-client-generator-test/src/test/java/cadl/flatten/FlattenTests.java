...
package cadl.flatten;

import cadl.flatten.implementation.FlattenClientImpl;
...
public class FlattenTests {
    ...
    public void testFlatten() {
        ...
        Assertions.assertEquals(
            "{\"endpoint\":\"host\",\"input\":\"input1\",\"constant\":\"constant\",\"requiredInt\":11,\"user\":{\"user\":\"user1\"}}",
