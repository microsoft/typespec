...
package azure.clientgenerator.core.apiversion.header.generated;
...
class HeaderClientTestBase extends TestProxyTestBase {
    protected HeaderClient headerClient;

    @Override
    protected void beforeTest() {
        HeaderClientBuilder headerClientbuilder = new HeaderClientBuilder()
        ...
        headerClient = headerClientbuilder.buildClient();
