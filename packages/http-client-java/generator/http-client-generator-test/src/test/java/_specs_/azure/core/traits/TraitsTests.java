...
import _specs_.azure.core.traits.models.UserActionParam;
...
public class TraitsTests {
    ...
    public void testGet() {
        ...
        client.smokeTest(1, "123",
            new RequestConditions().setIfMatch("\"valid\"")
    ...
    public void testPost() {
        Response<BinaryData> response
            = client.repeatableActionWithResponse(1, BinaryData.fromObject(new UserActionParam("test")), null);
        Assertions.assertEquals("accepted",
            response.getHeaders().getValue(HttpHeaderName.fromString("repeatability-result")));
    }
}
