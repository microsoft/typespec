...
const [getOperationKind, setOperationKindInternal, _getOperationKindMap] = useStateMap<Operation, GraphQLOperationKind>(GraphQLKeys.operationKind);

function validateOperationKindUniqueOnNode(
...
function setOperationKind(
  ...
  console.log("Setting operation kind: " + operationKind + " for operation: " + entity.name + " stored: " + getOperationKind(context.program, entity));
}
