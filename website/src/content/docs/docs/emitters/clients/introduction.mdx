...
JavaScript generally requires minimal configuration. However, it is recommended to provide `package-name` for package metadata, which is used in `package.json` and `README.md` files.
...
| ----------- | ---------------------------------------------------------------------- |
| package-name| Package name used in `package.json`                                    |
