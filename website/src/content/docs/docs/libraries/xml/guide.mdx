...
### 3.1 — Wrapped array of models (default)
...
### 3.3 — Wrapped array of models with custom wrapper name
...
### 3.4 — Unwrapped array of models with custom item name
...
### 3.5 — Wrapped array of models with custom wrapper and item names
...
```xml
<Book id="0">
  <xml-title>The Great Gatsby</xml-title>
  <author>F. Scott Fitzgerald</author>
</Book>
```
