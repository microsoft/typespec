...
### 4.1 — Wrapped primitive array (default)
...
### 4.3 — Wrapped primitive array with custom wrapper name
...
### 4.4 — Unwrapped primitive array with custom item name
...
### 4.5 — Wrapped primitive array with custom wrapper and item names
