...
- [`MergePatchCreateOrUpdate`](./data-types.md#TypeSpec.Http.MergePatchCreateOrUpdate)
- [`MergePatchUpdate`](./data-types.md#TypeSpec.Http.MergePatchUpdate)
...
- [`StripMetadata`](./data-types.md#TypeSpec.Http.StripMetadata)
