---
title: "Decorators (streams)"
description: "Decorators exported by @typespec/http/streams"
...
| Name    | Type                                 | Description                      |
| ------- | ------------------------------------ | -------------------------------- |
| options | `valueof TypeSpec.Http.PatchOptions` | Options for the PATCH operation. |
