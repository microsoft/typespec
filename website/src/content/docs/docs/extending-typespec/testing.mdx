...
import { MyTester } from "./test-host.js";
...
The tester use a builder pattern to allow you to configure tester. Each pipe provide a clone of the tester allowing you to create different tester without modifying the original one.
...
The base tester provide a way to easily collect types from the test code in order to use them in the test. There is 3 ways this can be achieved:
