...
TypeSpec provides extensions for Visual Studio and Visual Studio Code:
...
<Tabs>
  ...
  <TabItem label="VS Code Extension">
    ...
    1. click `Create TypeSpec Project` button from the Primary Sidebar of Explorer, or launch `>TypeSpec: Create TypeSpec Project` in the Command Pallette.
