...
### entity.isAssignableTo <Badge variant="note" text="Diagnosable" />
...
$(program).entity.isAssignableTo
  .withDiagnostics(source: Entity, target: Entity, diagnosticTarget?: Entity | Node): [boolean, readonly Diagnosable[]];
```

### entity.resolve <Badge variant="note" text="Diagnosable" />
...
$(program).entity.resolve
  .withDiagnostics(): [reference: stringEntity | undefined, readonly Diagnosable[]];
```
...
### model.getDiscriminatedUnion <Badge variant="note" text="Diagnosable" />
...
$(program).model.getDiscriminatedUnion
  .withDiagnostics(model: Model): [DiscriminatedUnionLegacy | undefined, readonly Diagnosable[]];
```
...
### operation.getPagingMetadata <Badge variant="note" text="Diagnosable" />
...
$(program).operation.getPagingMetadata
  .withDiagnostics(operation: Operation): [PagingOperation | undefined, readonly Diagnosable[]];
```
...
### type.isAssignableTo <Badge variant="note" text="Diagnosable" />
...
$(program).type.isAssignableTo
  .withDiagnostics(source: Type, target: Entity, diagnosticTarget?: Entity | Node): [boolean, readonly Diagnosable[]];
```
...
### type.resolve <Badge variant="note" text="Diagnosable" />
...
### union.getDiscriminatedUnion <Badge variant="note" text="Diagnosable" />
...
$(program).union.getDiscriminatedUnion
  .withDiagnostics(type: Union): [DiscriminatedUnion | undefined, readonly Diagnosable[]];
```
...
### value.isAssignableTo <Badge variant="note" text="Diagnosable" />
...
$(program).value.isAssignableTo
  .withDiagnostics(source: Value, target: Entity, diagnosticTarget?: Entity | Node): [boolean, readonly Diagnosable[]];
```
...
### value.resolve <Badge variant="note" text="Diagnosable" />
