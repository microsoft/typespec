...
description: Getting started with REST - 01 setup basic syntax
llmstxt: true
---
...
1. **Install Node.js**: Download and install Node.js from [nodejs.org](https://nodejs.org/). This will also install npm, the Node.js package manager. The minimum versions required are Node.js 22.0.0 and npm 7.0.0.
