---
title: Versioning
description: Getting started with REST - 06 versioning your REST API
llmstxt: true
---
...
```tsp title=main.tsp tryit="{"emit": ["@typespec/openapi3"]}" mark={2,5,9,12-15}
...
```tsp title=main.tsp tryit="{"emit": ["@typespec/openapi3"]}" mark={38-42}
import "@typespec/http";
import "@typespec/versioning";
...
```tsp title=main.tsp tryit="{"emit": ["@typespec/openapi3"]}" mark={125-180}
import "@typespec/http";
import "@typespec/versioning";
