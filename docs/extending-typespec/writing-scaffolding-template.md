...
| `naming.pascalCase(value: string)`    | Convert string to PascalCase                                    |
| `naming.camelCase(value: string)`     | Convert string to camelCase                                     |
| `naming.kebabCase(value: string)`     | Convert string to kebab-case                                    |
