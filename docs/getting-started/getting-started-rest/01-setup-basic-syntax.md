...
These comments have no meaning or significance in TypeSpec, we're simply using them to highlight the changes made in each step to help you follow along.
