...
namespace SampleTypeSpec
{
    ...
    public static partial class SampleTypeSpecModelFactory
    {
        ...
        {
            return new DynamicModelWithBase(name, additionalBinaryDataProperties: null, id);
        }
        ...
        {
            return new Dog("dog", name, weight, additionalBinaryDataProperties: null, bark);
        }
        ...
        {
            return new UnknownPet(kind, name, weight, additionalBinaryDataProperties: null);
        }
        ...
        {
            return new Cat("cat", name, weight, additionalBinaryDataProperties: null, meow);
        }
    }
}
