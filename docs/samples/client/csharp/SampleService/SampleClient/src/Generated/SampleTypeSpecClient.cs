...
namespace SampleTypeSpec
{
    ...
    public partial class SampleTypeSpecClient
    {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual CollectionResult ListWithStringNextLink(RequestOptions options)
        {
            try
            {
                System.Console.WriteLine("Entering method ListWithStringNextLink.");
                return new SampleTypeSpecClientListWithStringNextLinkCollectionResult(this, null, options);
            }
            catch (Exception ex)
            {
                System.Console.WriteLine($"An exception was thrown in method ListWithStringNextLink: {ex}");
                throw;
            }
            finally
            {
                System.Console.WriteLine("Exiting method ListWithStringNextLink.");
            }
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual AsyncCollectionResult ListWithStringNextLinkAsync(RequestOptions options)
        {
            try
            {
                System.Console.WriteLine("Entering method ListWithStringNextLinkAsync.");
                return new SampleTypeSpecClientListWithStringNextLinkAsyncCollectionResult(this, null, options);
            }
            catch (Exception ex)
            {
                System.Console.WriteLine($"An exception was thrown in method ListWithStringNextLinkAsync: {ex}");
                throw;
            }
            finally
            {
                System.Console.WriteLine("Exiting method ListWithStringNextLinkAsync.");
            }
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual CollectionResult<Thing> ListWithStringNextLink(CancellationToken cancellationToken = default)
        {
            try
            {
                System.Console.WriteLine("Entering method ListWithStringNextLink.");
                return new SampleTypeSpecClientListWithStringNextLinkCollectionResultOfT(this, null, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
            }
            catch (Exception ex)
            {
                System.Console.WriteLine($"An exception was thrown in method ListWithStringNextLink: {ex}");
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual AsyncCollectionResult<Thing> ListWithStringNextLinkAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                System.Console.WriteLine("Entering method ListWithStringNextLinkAsync.");
                return new SampleTypeSpecClientListWithStringNextLinkAsyncCollectionResultOfT(this, null, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
            }
            catch (Exception ex)
            {
                System.Console.WriteLine($"An exception was thrown in method ListWithStringNextLinkAsync: {ex}");
