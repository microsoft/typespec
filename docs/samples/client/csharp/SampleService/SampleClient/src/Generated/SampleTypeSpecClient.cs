...
namespace SampleTypeSpec
{
    ...
    public partial class SampleTypeSpecClient
    {
        ...
        public virtual ClientResult EnumQueryParameter(IEnumerable<QueryParameterEnum> queryParam = default, RequestOptions options = null)
        {
            try
            {
                System.Console.WriteLine("Entering method EnumQueryParameter.");
                using PipelineMessage message = CreateEnumQueryParameterRequest(queryParam, options);
                return ClientResult.FromResponse(Pipeline.ProcessMessage(message, options));
            }
            catch (Exception ex)
            {
                System.Console.WriteLine($"An exception was thrown in method EnumQueryParameter: {ex}");
                throw;
            }
            finally
            {
                System.Console.WriteLine("Exiting method EnumQueryParameter.");
            }
        }
        ...
        public virtual async Task<ClientResult> EnumQueryParameterAsync(IEnumerable<QueryParameterEnum> queryParam = default, RequestOptions options = null)
        {
            try
            {
                System.Console.WriteLine("Entering method EnumQueryParameterAsync.");
                using PipelineMessage message = CreateEnumQueryParameterRequest(queryParam, options);
                return ClientResult.FromResponse(await Pipeline.ProcessMessageAsync(message, options).ConfigureAwait(false));
            }
            catch (Exception ex)
            {
                System.Console.WriteLine($"An exception was thrown in method EnumQueryParameterAsync: {ex}");
                throw;
            }
            finally
            {
                System.Console.WriteLine("Exiting method EnumQueryParameterAsync.");
            }
        }
